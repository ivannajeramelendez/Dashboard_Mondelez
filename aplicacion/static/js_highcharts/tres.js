...
(function(X, N) {
  ...
  N(m, "Core/Time.js", [m["Core/Globals.js"], m["Core/Utilities.js"]], function(
    f,
    h
  ) {
    var m = h.defined,
    ...
    h = (function() {
      ...
      h.prototype.makeTime = function(n, l, h, w, r, d) {
        if (this.useUTC) {
          ...
          g = new this.Date(n, l, e(h, 1), e(w, 0), e(r, 0), e(d, 0)).getTime();
        return g;
      };
    ...
    function(f, h, m) {
      ...
      m = (function() {
        ...
        f.prototype.render = function() {
          ...
          G = {
            class:
              "highcharts-plot-" + (q ? "band " : "line ") + (w.className || "")
          };
          var O = {},
            E = n.chart.renderer,
            u = q ? "bands" : "lines";
            ...
            m.forEach(function(m) {
              ...
              e.chart.styledMode ||
                (w.fill = C(
                  m[3],
                  L(m[2])
                    .setOpacity(C(h.fillOpacity, 0.75))
                    .get()
                ));
              l[v](w);
              l.startX = f.xMap;
            ...
            ? ((b = !1),
              ...
              (r = {
                ...
                y:
                  a.y +
                  (c.y || 0) +
                  { top: 0, middle: 0.5, bottom: 1 }[c.verticalAlign] * a.height
              }),
              t(r),
