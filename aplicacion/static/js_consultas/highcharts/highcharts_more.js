...
(function(c) {
  ...
  A(
    ...
    [
      ...
      c["Core/Pointer.js"],
      c["Core/Utilities.js"],
      c["Mixins/CenteredSeries.js"]
    ],
    function(c, b, h, a, f) {
      function q(e, f, m) {
        return (
          Math.sqrt(Math.pow(e - m[0], 2) + Math.pow(f - m[1], 2)) <= m[2] / 2
        );
      }
      var u = a.addEvent,
        z = a.extend,
      ...
      a = (function() {
        ...
        b.prototype.render = function() {
          ...
          if (m)
            for (
              m = e(m),
                b = Math.max(m.length, this.background.length || 0),
                f = 0;
              f < b;
              f++
            )
              m[f] && this.axis
                ? this.renderBackground(
                    E(this.defaultBackgroundOptions, m[f]),
                    f
                  )
                : this.background[f] &&
                  ((this.background[f] = this.background[f].destroy()),
                  this.background.splice(f, 1));
        };
        b.prototype.renderBackground = function(e, f) {
          var b = "animate",
            m = { class: "highcharts-pane " + (e.className || "") };
          ...
          this.background[f] ||
            ((this.background[f] = this.chart.renderer.path().add(this.group)),
            (b = "attr"));
          this.background[f][b]({
      ...
      u(h, "beforeGetHoverData", function(e) {
        ...
        f.polar &&
          ...
          (e.filter = function(b) {
            return (
              b.visible &&
              !(!e.shared && b.directTouch) &&
              B(b.options.enableMouseTracking, !0) &&
              (!f.hoverPane || b.xAxis.pane === f.hoverPane)
            );
          }));
      });
      u(h, "afterGetHoverData", function(e) {
        ...
        e.hoverPoint &&
          ...
          e.hoverPoint.plotY &&
          f.hoverPane &&
          !q(e.hoverPoint.plotX, e.hoverPoint.plotY, f.hoverPane.center) &&
          (e.hoverPoint = void 0);
      });
      b.Pane = a;
      return b.Pane;
      ...
      a = (function() {
        ...
        b.init = function(f) {
          ...
          f.getLinePath = function(f, l, k) {
            ...
            "undefined" === typeof k &&
              (k = this.horiz ? 0 : this.center && -this.center[3] / 2);
            k && (g += k);
            this.isCircular || "undefined" !== typeof l
              ? ((l = this.chart.renderer.symbols.arc(
                  this.left + f[0],
                  this.top + f[1],
                  g,
                  g,
              ...
              : ((l = this.postTranslate(this.angleRad, g)),
                (l = [
                  [
                    "M",
                    this.center[0] + d.plotLeft,
                    this.center[1] + d.plotTop
                  ],
                  ["L", l.x, l.y]
                ]));
            return l;
          ...
          f.getPosition = function(f, l) {
            ...
            return this.postTranslate(
              ...
              e(this.isCircular ? l : 0 > f ? 0 : f, this.center[2] / 2) -
                this.offset
            );
          };
          ...
          f.getPlotBandPath = function(f, l, k) {
            ...
            if ("polygon" === this.options.gridLineInterpolation)
              t = this.getPlotLinePath({ value: f }).concat(
                this.getPlotLinePath({ value: l, reverse: !0 })
              );
            else {
              ...
              b -= t;
              t = this.chart.renderer.symbols.arc(
                this.left + g[0],
                this.top + g[1],
                b,
                b,
          ...
          f.getCrosshairPosition = function(e, l, k) {
            ...
            if (this.isCircular) {
                ...
                e.point &&
                  ...
                  r.start &&
                    (d = this.chart.inverted
                      ? this.translate(e.point.rectPlotY, !0)
                      : e.point.x));
              else {
                var r = e.chartX || 0;
                var D = e.chartY || 0;
                d = this.translate(
                  Math.atan2(D - k, r - l) - this.startAngleRad,
                  !0
                );
              }
              ...
              u(d) || ((r = e.chartX), (D = e.chartY)),
                u(r) &&
                  u(D) &&
                  ((k = g[1] + this.chart.plotTop),
                  (d = this.translate(
                    Math.min(
                      Math.sqrt(Math.pow(r - l, 2) + Math.pow(D - k, 2)),
                      g[2] / 2
                    ) -
                      g[3] / 2,
                    !0
          ...
          f.getPlotLinePath = function(e) {
            var l = this,
              ...
              D = e.reverse,
              t = l.getPosition(r),
              n = l.pane.options.background
                ? l.pane.options.background[0] || l.pane.options.background
                : {},
              f = n.innerRadius || "0%",
              b = n.outerRadius || "100%";
            n = k[0] + d.plotLeft;
            ...
            var v;
            e.isCrosshair &&
              ((m = this.getCrosshairPosition(e, n, a)),
              (r = m[0]),
              (p = m[1]),
              (m = m[2]));
            if (l.isCircular)
              ...
              ((r = l.translate(r)) && (0 > r || r > h) && (r = 0),
              "circle" === l.options.gridLineInterpolation)
            )
              k = l.getLinePath(0, r, t);
            else if (
              ((k = []),
              ...
              for (
                ...
                (a = v.getPosition(n[p], r)),
                  k.push(p ? ["L", a.x, a.y] : ["M", a.x, a.y]);
            return k;
          };
          f.getTitlePosition = function() {
            ...
            return {
              ...
              y:
                l.plotTop +
                e[1] -
                { high: 0.5, middle: 0.25, low: 0 }[k.align] * e[2] +
                (k.y || 0)
            };
          };
          f.createLabelCollector = function() {
            ...
            return function() {
              if (
                e.isRadial &&
                e.tickPositions &&
                !0 !== e.options.labels.allowOverlap
              )
        ...
        b.compose = function(a, m) {
          f(a, "init", function(e) {
            ...
            if ("colorAxis" === D) this.isRadial = !1;
              ...
              if (d) {
                if ((t ? h.init(this) : b.init(this), (n = !r)))
                  this.defaultPolarOptions = b.defaultRadialGaugeOptions;
              } else
                g &&
                  (b.init(this),
                  (this.defaultPolarOptions = (n = this.horiz)
              ...
              d || g
                ? ((this.isRadial = !0),
                  (f.chart.zoomType = null),
                  this.labelCollector ||
                    (this.labelCollector = this.createLabelCollector()),
                  this.labelCollector &&
                    l.labelCollectors.push(this.labelCollector))
                : (this.isRadial = !1);
              e && n && (e.axis = this);
              this.isCircular = n;
            }
          ...
          f(a, "afterInit", function() {
            ...
            (f.angular && this.isXAxis) ||
              ...
              (this.endAngleRad =
                ((e(d.endAngle, d.startAngle + 360) - 90) * Math.PI) / 180),
          ...
          f(m, "afterGetLabelPosition", function(f) {
            ...
            if (k) {
              var d = k.getBBox(),
                ...
                t = g.align,
                n =
                  (((l.translate(this.pos) + l.startAngleRad + Math.PI / 2) /
                    Math.PI) *
                    180) %
                  360,
                y = Math.round(n),
              ...
              if (l.isRadial) {
                var c = l.getPosition(
                  this.pos,
                  l.center[2] / 2 +
                    x(e(g.distance, -25), l.center[2] / 2, -l.center[2] / 2)
                );
                "auto" === g.rotation
                  ? k.attr({ rotation: n })
                  : null === r &&
                    (r =
                      l.chart.renderer.fontMetrics(
                        k.styles && k.styles.fontSize
                      ).b -
                      d.height / 2);
                null === t &&
                  (l.isCircular
                    ? (d.width > (l.len * l.tickInterval) / (l.max - l.min) &&
                        (D = 0),
                      (t =
                        n > D && n < 180 - D
                          ? "left"
                ...
                if (
                  ...
                  180 < m && 360 >= m && (m = 360 - m);
                  if (
                    l.pane.options.startAngle === y ||
                    l.pane.options.startAngle === y + 360 ||
                    l.pane.options.startAngle === y - 360
                  )
                    b = "start";
                  t =
                  ...
                  15 > a || (180 <= a && 195 > a)
                    ...
                    : 215 < a &&
                      270 >= a &&
                      (h = "start" === b ? d.height : 0.25 * -d.height);
                  15 > m
                    ? (v = "start" === b ? 0.15 * -d.height : 0.15 * d.height)
                    : 165 < m &&
                      180 >= m &&
                      (v = "start" === b ? 0.15 * d.height : 0.15 * -d.height);
                  k.attr({ align: t });
          ...
          w(m.prototype, "getMarkPath", function(e, l, k, d, g, r, D) {
            var t = this.axis;
            t.isRadial
              ? ((e = t.getPosition(this.pos, t.center[2] / 2 + d)),
                (l = ["M", l, k, "L", e.x, e.y]))
              : (l = e.call(this, l, k, d, g, r, D));
            return l;
          });
        };
        b.defaultCircularOptions = {
    ...
    function(c, b, h, a) {
      ...
      c.seriesType(
        ...
        },
        {
          ...
          highToXY: function(e) {
            var f = this.chart,
              b = this.xAxis.postTranslate(
                e.rectPlotX,
                this.yAxis.len - e.plotHigh
              );
          ...
          translate: function() {
            ...
            e.points.forEach(function(a) {
              ...
              a.isNull
                ? (a.plotY = null)
                : ((a.plotLow = k),
                  (a.plotHigh = f.translate(
                    b ? e.modifyValue(l, a) : l,
                    0,
                    1,
                    0,
                    1
                  )),
                  b && (a.yBottom = a.plotHigh));
            });
            this.chart.polar &&
          ...
          getGraphPath: function(e) {
            ...
            for (a = e.length; a--; ) {
              var t = e[a];
              var n = d
                ? { plotX: t.rectPlotX, plotY: t.yBottom, doCurve: !1 }
                : { plotX: t.plotX, plotY: t.plotY, doCurve: !1 };
            ...
            D &&
              (!0 === D && (D = "left"),
              (k.step = { left: "right", center: "center", right: "left" }[D]));
            f = l.call(this, f);
            b = l.call(this, b);
            k.step = D;
            k = [].concat(e, f);
          ...
          drawDataLabels: function() {
            ...
            if (g.enabled || this._hasPointLabels) {
              for (b = f; b--; )
                if ((k = e[b])) {
                  ...
                  k.below = D;
                  d
                    ? g.align || (g.align = D ? "right" : "left")
                    : g.verticalAlign ||
                      (g.verticalAlign = D ? "top" : "bottom");
                }
              ...
              for (b = f; b--; )
                if ((k = e[b]))
                  (D = r.inside
                    ...
                    (k.below = !D),
                    d
                      ? r.align || (r.align = D ? "left" : "right")
                      : r.verticalAlign ||
                        (r.verticalAlign = D ? "bottom" : "top");
            ...
            if (g.enabled)
              for (b = f; b--; )
                if ((k = e[b]))
                  k.dataLabels = [k.dataLabelUpper, k.dataLabel].filter(
                    function(d) {
                      return !!d;
                    }
                  );
          ...
          drawPoints: function() {
            ...
            for (b = 0; b < e; )
              (a = this.points[b]),
                (a.upperGraphic = a.graphic),
                (a.graphic = a.lowerGraphic),
                q(a, a.origProps),
                delete a.origProps,
                b++;
          },
        ...
        },
        {
          setState: function() {
            ...
            f(this.plotLow) ||
              (this.plotLow = this.plotY = a.yAxis.toPixels(this.low, !0));
          ...
          haloPath: function() {
            ...
            this.isTopInside &&
              (a = a.concat(x.haloPath.apply(this, arguments)));
            return a;
          },
  ...
  A(
    ...
    function(c, b, h, a) {
      ...
      c.seriesType(
        "columnrange",
        "arearange",
        q(h.plotOptions.column, h.plotOptions.arearange, {
          pointRange: null,
          marker: null,
          states: { hover: { halo: !1 } }
        }),
          ...
          translate: function() {
            ...
            a.points.forEach(function(l) {
              ...
              q
                ? ((c = l.barX + h),
                  (l.shapeType = "arc"),
                  (l.shapeArgs = a.polarArc(g + r, g, c, c + l.pointWidth)))
                : ((k.height = r),
                  (k.y = g),
                  (l.tooltipPos = m.inverted
                    ? [
                        b.len + b.pos - m.plotLeft - g - r / 2,
                        e.len + e.pos - m.plotTop - k.x - k.width / 2,
                        r
                      ]
                    : [
                        e.left - m.plotLeft + k.x + k.width / 2,
                        b.pos - m.plotTop + g + r / 2,
                        r
                      ]));
            });
          },
        ...
        {},
        {
          translate: function() {
            ...
            b.points.forEach(function(k) {
              ...
              k.barX = g;
              k.pointWidth = v;
              k.tooltipPos = h.inverted
                ? [e.len + e.pos - h.plotLeft - r, b.xAxis.len - g - a, d]
                : [g + a, r + e.pos - h.plotTop, d];
              r = x + (k.total || k.y);
              "percent" === c.stacking && (r = x + (0 > k.y) ? -100 : 100);
              r = e.toPixels(r, !0);
              var y = (n = h.plotHeight - r - (h.plotHeight - w))
                ? (a * (t - r)) / n
                : 0;
              var G = n ? (a * (t + d - r)) / n : 0;
              n = g - y + a;
  ...
  A(
    ...
    [c["Core/Series/Series.js"], c["Core/Globals.js"], c["Core/Utilities.js"]],
    function(c, b, h) {
      var a = h.clamp,
        f = h.isNumber,
        q = h.merge,
        ...
        },
        {
          ...
          translate: function() {
            ...
            this.points.forEach(function(c) {
              ...
              if (f(d) || !1 === e.wrap)
                (d = f(d) ? (d / 180) * Math.PI : 0),
                  (g = a(g, b.startAngleRad - d, b.endAngleRad + d));
              g = (180 * g) / Math.PI;
              c.shapeType = "path";
              c.shapeArgs = {
                d: m.path || [
          ...
          drawPoints: function() {
            ...
            a.points.forEach(function(b) {
              ...
              f
                ? (f.animate(k), (k.d = d))
                : (b.graphic = z[b.shapeType](k)
                    .attr({ rotation: k.rotation, zIndex: 1 })
                    .addClass("highcharts-dial")
                    .add(a.group));
              if (!e.styledMode)
                b.graphic[f ? "animate" : "attr"]({
          ...
          translate: function() {
            ...
            this.points.forEach(function(f) {
              b.forEach(function(b) {
                null !== f[b] &&
                  (f[b + "Plot"] = a.translate(f[b], 0, 1, 0, 1));
              });
            ...
            a.points.forEach(function(n) {
              ...
              "undefined" !== typeof n.plotY &&
                ...
                f.styledMode ||
                  ...
                  (F.dashstyle =
                    n.stemDashStyle || b.stemDashStyle || b.dashStyle),
                  n.stem.attr(F),
                  t &&
                    ...
                    (J.dashstyle =
                      n.whiskerDashStyle || b.whiskerDashStyle || b.dashStyle),
                    n.whiskers.attr(J)),
                  r &&
                    ((I.fill = n.fillColor || b.fillColor || u),
                    (I.stroke = b.lineColor || u),
                    (I["stroke-width"] = b.lineWidth || 0),
                    (I.dashstyle =
                      n.boxDashStyle || b.boxDashStyle || b.dashStyle),
                    n.box.attr(I)),
                  ...
                  (K.dashstyle =
                    n.medianDashStyle || b.medianDashStyle || b.dashStyle),
  ...
  A(
    ...
    [c["Core/Series/Series.js"], c["Core/Globals.js"]],
    function(c, b) {
      b = b.noop;
      var h = c.seriesTypes;
      c.seriesType(
        ...
        },
        {
            ...
            for (e = h.length; c < e; c++) {
              ...
              if (t) {
                if (n) {
                  ...
                  if ("overlap" === t) {
                    ...
                    u = 0 <= w ? u : u - w;
                    Object.hasOwnProperty.call(p, "absolutePos") &&
                      delete p.absolutePos;
                    Object.hasOwnProperty.call(p, "absoluteNeg") &&
                      delete p.absoluteNeg;
                  } else
                    0 <= w
                      ? ((u = p.threshold + p.posTotal), (p.posTotal -= w))
                      : ((u = p.threshold + p.negTotal),
                        (p.negTotal -= w),
                        (u -= w)),
                      !p.posTotal &&
                        Object.hasOwnProperty.call(p, "absolutePos") &&
                        ((p.posTotal = p.absolutePos), delete p.absolutePos),
                      !p.negTotal &&
                        Object.hasOwnProperty.call(p, "absoluteNeg") &&
                        ((p.negTotal = p.absoluteNeg), delete p.absoluteNeg);
                  m.isSum ||
                    (p.connectorThreshold = p.threshold + p.stackTotal);
                  a.reversed
                    ? ((x = 0 <= w ? u - w : u + w), (w = u))
                    : ((x = u), (w = u - w));
                  m.below = x <= C(f, 0);
                ...
                if ((w = a.waterfall.dummyStackItem))
                  (w.x = c),
                    (w.label = n[c].label),
                    w.setOffset(
                      this.pointXOffset || 0,
                ...
                (u = Math.max(y, y + w) + p[0]),
                  ...
                  m.isSum
                    ? ((q.y = a.translate(p[1], 0, 1, 0, 1)),
                      (q.height =
                        Math.min(a.translate(p[0], 0, 1, 0, 1), a.len) - q.y))
                    : m.isIntermediateSum
                    ? (0 <= w
                        ? ((x = p[1] + d), (w = d))
                        : ((x = d), (w = p[1] + d)),
                      ...
                      (q.y = a.translate(x, 0, 1, 0, 1)),
                      (q.height = Math.abs(
                        q.y - Math.min(a.translate(w, 0, 1, 0, 1), a.len)
                      )),
                      (d += p[1]))
                    : ((q.height =
                        0 < x
                          ? a.translate(y, 0, 1, 0, 1) - q.y
                          : a.translate(y, 0, 1, 0, 1) -
                            a.translate(y - x, 0, 1, 0, 1)),
                      (y += x),
                      (m.below = y < C(f, 0))),
              ...
              q.height <= g && !m.isNull
                ? ((q.height = g),
                  (q.y -= b),
                  (m.plotY = q.y),
                  (m.minPointLengthOffset = 0 > m.y ? -b : b))
                : (m.isNull && (q.width = 0), (m.minPointLengthOffset = 0));
              q = m.plotY + (m.negative ? q.height : 0);
              this.chart.inverted
                ? (m.tooltipPos[0] = a.len - q)
                : (m.tooltipPos[1] = q);
            }
          },
          processData: function(a) {
            ...
            for (c = n = t = l = h = 0; c < b; c++) {
              ...
              "sum" === m || q.isSum
                ? (d[c] = x(n))
                : "intermediateSum" === m || q.isIntermediateSum
                ? ((d[c] = x(t)), (t = 0))
                : ((n += m), (t += m));
              l = Math.min(n, l);
              h = Math.max(n, h);
              ...
              p &&
                ...
                n
                  ? ((p = p.connectorThreshold),
                    (x =
                      Math.round(e.translate(p, 0, 1, 0, 1) + (t ? x : 0)) - g))
                  : (x = q.y + m.minPointLengthOffset + b - g),
                y.push(
                  ["M", (q.x || 0) + (f ? 0 : q.width || 0), x],
                  ["L", (h.x || 0) + (f ? h.width || 0 : 0), x]
                ));
              !n &&
                y.length &&
                q &&
                ((0 > m.y && !t) || (0 < m.y && t)) &&
                ((y[y.length - 2][2] += q.height),
                (y[y.length - 1][2] += q.height));
            }
            return y;
          },
          drawGraph: function() {
    ...
    function(c, b, h) {
      ...
      c.seriesType(
        ...
        },
        {
          ...
          getGraphPath: function() {
            for (
              var a = f.prototype.getGraphPath.call(this), b = a.length + 1;
              b--;
    ...
    function(c, b, h, a, f) {
      ...
      w = (function() {
        ...
        a.prototype.drawLegendSymbol = function(a) {
          ...
          this.fontMetrics = d.renderer.fontMetrics(
            g.labels.style.fontSize.toString() + "px"
          );
        ...
        a.prototype.setOptions = function() {
          ...
          a.forEach(function(t, r) {
            h ||
              ((b.stroke = x(t.borderColor, d.borderColor, g.color)),
              (b.fill = x(
                t.color,
                d.color,
                1 !== c
              ...
              (f.stroke = x(t.connectorColor, d.connectorColor, g.color)));
        ...
        a.prototype.hideOverlappingLabels = function() {
          ...
          !this.options.labels.allowOverlap &&
            ...
            d.labels.forEach(function(a, e) {
              a.newOpacity
                ? a.newOpacity !== a.oldOpacity && d.connectors[e].show()
                : d.connectors[e].hide();
            }));
        };
          ...
          a.chart.series.forEach(function(d) {
            d.isBubble &&
              ...
              g.length &&
                ...
                (b = x(d.options.zMax, Math.max(b, u(g))))));
          });
          var f =
            e === b
              ? [{ value: b }]
      ...
      b(a, "afterGetAllItems", function(a) {
        ...
        0 <= b &&
          ...
          g.enabled &&
          ((g.seriesIndex = b),
          (this.bubbleLegend = new h.BubbleLegend(g, this)),
      ...
      a.prototype.getLinesHeights = function() {
        ...
        for (g = 0; g < d; g++)
          if (
            (a[g].legendItemHeight && (a[g].itemHeight = a[g].legendItemHeight),
            a[g] === a[d - 1] ||
              (a[g + 1] &&
                a[g]._legendItemPos[1] !== a[g + 1]._legendItemPos[1]))
          ) {
            e.push({ height: 0 });
            var f = e[e.length - 1];
            for (b; b <= g; b++)
      ...
      a.prototype.retranslateItems = function(a) {
        ...
        this.allItems.forEach(function(t, n) {
          ...
          if ((g = t.movementX) || (b && t.ranges))
            (g = b ? e - t.options.maxSize / 2 : e + g),
              t.legendGroup.attr({ translateX: g });
          n > a[f].step && f++;
      ...
      c.prototype.beforePadding = function() {
        ...
        C.length &&
          ...
          [
            ...
            "undefined" === typeof w(a.options[d[0]], a[d[1]]) &&
              (a[d[0]] += d[2] / F);
          }));
      };
      ("");
  ...
  A(c, "Series/Networkgraph/Integrations.js", [c["Core/Globals.js"]], function(
    c
  ) {
    c.networkgraphIntegrations = {
      verlet: {
        ...
        attractive: function(b, c, a) {
          ...
          b.fromNode.fixedPosition ||
            ((b.fromNode.plotX -= (h * f.fromNode) / b.fromNode.degree),
            (b.fromNode.plotY -= (c * f.fromNode) / b.fromNode.degree));
          b.toNode.fixedPosition ||
            ((b.toNode.plotX += (h * f.toNode) / b.toNode.degree),
            (b.toNode.plotY += (c * f.toNode) / b.toNode.degree));
        },
      ...
      euler: {
        ...
        attractive: function(b, c, a, f) {
          ...
          c *= a.y / f;
          b.fromNode.fixedPosition ||
            ((b.fromNode.dispX -= (u * h.fromNode) / b.fromNode.degree),
            (b.fromNode.dispY -= (c * h.fromNode) / b.fromNode.degree));
          b.toNode.fixedPosition ||
            ((b.toNode.dispX += (u * h.toNode) / b.toNode.degree),
            (b.toNode.dispY += (c * h.toNode) / b.toNode.degree));
        },
        integrate: function(b, c) {
          ...
          0 !== a &&
            ((c.plotX +=
              (c.dispX / a) * Math.min(Math.abs(c.dispX), b.temperature)),
            (c.plotY +=
              (c.dispY / a) * Math.min(Math.abs(c.dispY), b.temperature)));
        },
        getK: function(b) {
      ...
      z(h.layouts["reingold-fruchterman"].prototype, {
        ...
        setCircularPositions: function() {
          function a(b) {
            b.linksFrom.forEach(function(d) {
              p[d.toNode.id] ||
                ((p[d.toNode.id] = !0), q.push(d.toNode), a(d.toNode));
            });
          }
          var b = this.box,
            c = this.nodes,
        ...
        barnesHutApproximation: function(a, b) {
          ...
          if (a !== b && 0 !== c)
            if (b.isInternal)
              ...
              (f = this.repulsiveForce(c, this.k)),
                this.force("repulsive", a, f * b.mass, e, c);
          return h;
        },
        ...
        attractiveForces: function() {
          ...
          a.links.forEach(function(e) {
            e.fromNode &&
              e.toNode &&
              ((b = a.getDistXY(e.fromNode, e.toNode)),
              (c = a.vectorLength(b)),
              0 !== c &&
                ((f = a.attractiveForce(c, a.k)),
                a.force("attractive", e, f, b, c)));
          });
        },
      ...
      b(c, "render", function() {
        function a(a) {
          a.maxIterations-- &&
            ...
            !a.isStable() &&
            !a.enableSimulation &&
            (a.beforeStep && a.beforeStep(), a.step(), (c = !1), (b = !0));
        }
        var b = !1;
        ...
        barycenter: function() {
          ...
          e.forEach(function(d) {
            a.options.splitSeries && !d.isParentNode
              ? ((f = d.series.parentNode.plotX),
                (n = d.series.parentNode.plotY))
              : ((f = c.width / 2), (n = c.height / 2));
            d.fixedPosition ||
              ((d.plotX -=
                ((d.plotX - f) * b) / (d.mass * Math.sqrt(e.length))),
              (d.plotY -=
                ((d.plotY - n) * b) / (d.mass * Math.sqrt(e.length))));
          });
        },
          ...
          a.nodes.forEach(function(d) {
            ...
            a.nodes.forEach(function(g) {
              ...
              d === g ||
                ...
                ((e = a.getDistXY(d, g)),
                (c =
                  a.vectorLength(e) - (d.marker.radius + g.marker.radius + f)),
                0 > c &&
                  ((d.degree += 0.01),
                  d.neighbours++,
                  (b = a.repulsiveForce(
                    -c / Math.sqrt(d.neighbours),
                    a.k,
                    d,
                    g
                  ))),
      ...
      c.seriesType(
        ...
        },
        {
          ...
          createParentNodes: function() {
            ...
            e ||
              ...
              a.parentNode &&
                ((f.plotX = a.parentNode.plotX),
                (f.plotY = a.parentNode.plotY)),
              (a.parentNode = f),
          ...
          addSeriesLayout: function() {
            ...
            f ||
              ((b[d.type + "-series"] = f = new a.layouts[d.type]()),
              f.init(e),
              c.splice(f.index, 0, f));
          ...
          addLayout: function() {
            ...
            b ||
              ...
              (this.chart.graphLayoutsLookup = c = []));
            var f = b[d.type];
            f ||
              ((d.enableSimulation = B(e.forExport)
                ? !e.forExport
                : d.enableSimulation),
              (b[d.type] = f = new a.layouts[d.type]()),
              f.init(d),
              c.splice(f.index, 0, f));
            this.layout = f;
            this.points.forEach(function(a) {
          ...
          translate: function() {
            ...
            for (f = 0; f < n.length; f++)
              if (n[f][3] === c) {
                ...
                var l = n[f][2];
                t ||
                  ((h.plotX = n[f][0] - a.plotLeft + a.diffX),
                  (h.plotY = n[f][1] - a.plotTop + a.diffY));
                h.marker = e(h.marker, {
                  radius: l,
                  width: 2 * l,
                  height: 2 * l
          ...
          resizeRadius: function() {
            ...
            if (1e-10 < Math.abs(c - 1)) {
              ...
              (a.diffY = h / 2 + n - k - (q - k) / 2),
                (a.diffX = l / 2 + f - p - (u - p) / 2);
          },
              ...
              e &&
                ...
                e.nodes.forEach(function(e) {
                  a &&
                    ...
                    0 > d &&
                      (e.series.addPoint(
                        C(a.options, { plotX: a.plotX, plotY: a.plotY }),
                        !1
                      ),
                      c.removeElementFromCollection(a, c.nodes),
                      a.remove()));
                });
        ...
        },
        {
          ...
          select: function(a, c) {
            ...
            this.isParentNode
              ? ((d.getSelectedPoints = d.getSelectedParentNodes),
                f.prototype.select.apply(this, arguments),
                (d.getSelectedPoints = b.prototype.getSelectedPoints))
              : f.prototype.select.apply(this, arguments);
          }
        }
      );
    ...
    function(c, b, h, a, f, q, u) {
      ...
      l.searchPointByAngle = function(a) {
        ...
        return this.searchKDTree({
          clientX:
            ...
            (-180 / Math.PI) *
              Math.atan2(
                a.chartX - d[0] - b.plotLeft,
                a.chartY - d[1] - b.plotTop
              )
        });
      };
      ...
      l.toXY = function(a) {
        ...
        k &&
          h &&
          !h.isRadialBar &&
          (a.plotY = f = "number" === typeof l ? c.translate(l) || 0 : 0);
        a.rectPlotX = e;
        a.rectPlotY = f;
        ...
        this.kdByAngle
          ? ((b = ((e / Math.PI) * 180 + d.pane.options.startAngle) % 360),
            0 > b && (b += 360),
            (a.clientX = b))
          : (a.clientX = a.plotX);
      };
      p.spline &&
        (c(p.spline.prototype, "getPointSpline", function(a, b, c, e) {
          this.chart.polar
            ? e
              ? ((a = this.getConnectors(b, e, !0, this.connectEnds)),
                (a = [
                  "C",
                ...
                if (!b) {
                  ...
                  c.points.forEach(function(a) {
                    ...
                    p &&
                      q &&
                      (p.attr({ r: x, innerR: x }),
                      p.animate({ r: u, innerR: v }, c.options.animation));
                  });
                }
              } else
                b
            ...
            for (; e--; ) {
              ...
              if (d.inverted) {
                ...
                if (c && f.stacking) {
                  if (
                    ((E =
                      f.stacking.stacks[(0 > E ? "-" : "") + this.stackKey]),
                    this.visible && E && E[z] && !b.isNull)
                  ) {
                    var C =
                      E[z].points[
                ...
                b.plotY =
                  (B(this.translatedThreshold) &&
                    (A < this.translatedThreshold ? A : C)) - l;
              } else
                (A = w + l),
              ...
              this.toXY(b);
              d.inverted
                ? ((w = f.postTranslate(b.rectPlotY, w + b.pointWidth / 2)),
            ...
            ? ((a = (b.rectPlotX / Math.PI) * 180),
              d.inverted
                ? ((this.forceDL = d.isInsidePlot(
                  ...
                  g && b.shapeArgs
                    ? ((f = b.shapeArgs),
                      (f = this.yAxis.postTranslate(
                        (f.start + f.end) / 2 - this.xAxis.startAngleRad,
                        b.barX + b.pointWidth / 2
                      )),
                      (f = { x: f.x - d.plotLeft, y: f.y - d.plotTop }))
                    : b.tooltipPos &&
                      (f = { x: b.tooltipPos[0], y: b.tooltipPos[1] }),
      ...
      q.prototype.clipCircle = function(a, b, c, e) {
        var d = C(),
          f = this.createElement("clipPath")
            ...
            .add(this.defs);
        a = e
          ? this.arc(a, b, c, e, 0, 2 * Math.PI).add(f)
