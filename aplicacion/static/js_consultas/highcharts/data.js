...
(function(b) {
  "object" === typeof module && module.exports
    ...
    ? define("highcharts/modules/data", ["highcharts"], function(q) {
        b(q);
        b.Highcharts = q;
        return b;
      })
    ...
    function(b, x) {
      ...
      b.ajax = function(b) {
        ...
        m.headers["Content-Type"] ||
          r.setRequestHeader("Content-Type", b[m.dataType] || b.text);
    ...
    function(b, q, H, v, I, m) {
      ...
      q = (function() {
        ...
        b.prototype.init = function(a, c, f) {
          ...
          this.hasURLOption(a) &&
            (clearTimeout(this.liveDataTimeout), (h = !1));
            ...
            function g() {
              e > u || u > m
                ...
                : (!isNaN(parseFloat(n)) && isFinite(n)
                    ? ((n = parseFloat(n)), h("number"))
                    : isNaN(Date.parse(n))
                    ? h("string")
                    : ((n = n.replace(/\//g, "-")), h("date")),
                  A.length < t + 1 && A.push([]),
                  f || (A[t][c] = n),
                  (n = ""),
                  ++t,
              ...
              if ("undefined" !== typeof a[f] && a[f] && a[f].length) {
                ...
                for (e = 0; e < l.length; e++)
                  e < d.length &&
                    ((l[e] = parseInt(l[e], 10)),
                    l[e] &&
                      ((n[e] = !n[e] || n[e] < l[e] ? l[e] : n[e]),
                      "undefined" !== typeof k[e]
                        ? k[e] !== l[e] && (k[e] = !1)
                        : (k[e] = l[e]),
                      31 < l[e]
                        ? (d[e] = 100 > l[e] ? "YY" : "YYYY")
              ...
              for (e = 0; e < k.length; e++)
                !1 !== k[e]
                  ? 12 < n[e] &&
                    ...
                    "YYYY" !== d[e] &&
                    (d[e] = "YY")
                  : 12 < n[e] && "mm" === d[e] && (d[e] = "dd");
              3 === d.length && "dd" === d[1] && "dd" === d[2] && (d[2] = "YY");
              a = d.join("/");
              return (b.dateFormats || h.dateFormats)[a]
                ? a
        ...
        b.prototype.parseTable = function() {
          ...
          c &&
            ("string" === typeof c && (c = x.getElementById(c)),
              ...
              c >= d &&
                ...
                [].forEach.call(a.children, function(a, b) {
                  ...
                  if (
                    ...
                    for (
                      f[b - g] || (f[b - g] = []),
                        f[b - g][c - d] = a.innerHTML;
                      c - d >= e && void 0 === h[c - d - e];
          ...
          function a(h) {
            function e(e, l, n) {
              function m() {
                g &&
                  f.liveDataURL === e &&
                  (c.liveDataTimeout = setTimeout(a, k));
              }
              if (!e || 0 !== e.indexOf("http"))
                return e && d.error && d.error("Invalid URL"), !1;
            ...
            e(
              ...
              e(l.rowsURL, function(a) {
                f.update({ data: { rows: a } });
              }) ||
              e(l.columnsURL, function(a) {
                f.update({ data: { columns: a } });
              });
          }
          var c = this,
            f = this.chart,
            ...
            a(function(a) {
              ...
              for (g = 0; g < f; g++) {
                ...
                if (q >= e && q <= m && h >= k && h <= l) {
                  ...
                  u.numericValue
                    ? (p =
                        0 <= u.$t.indexOf("/") || 0 <= u.$t.indexOf("-")
                          ? u.$t
                          : 0 < u.$t.indexOf("%")
                          ? 100 * parseFloat(u.numericValue)
                          : parseFloat(u.numericValue))
                    : u.$t && u.$t.length && (p = u.$t);
                  d[q - e][h - k] = p;
                }
              }
        ...
        b.prototype.parseColumn = function(a, c) {
          ...
          m =
            k &&
            ((m && m.xAxis && "category" === N(m.xAxis)[0].type) ||
              "string" === q);
          for (f[c] || (f[c] = []); b--; ) {
            var n = e[b] || a[b];
            var r = this.trim(n);
            ...
            m || (0 === b && g)
              ...
              ? ((a[b] = t),
                31536e6 < t && "float" !== q
                  ? (a.isDatetime = !0)
                  : (a.isNumeric = !0),
                "undefined" !== typeof a[b + 1] && (p = t > a[b + 1]))
              : (r && r.length && (l = this.parseDate(n)),
                k && E(l) && "float" !== q
                  ? ((e[b] = n),
                    (a[b] = l),
                    (a.isDatetime = !0),
          ...
          if (c) var g = c(a);
            ...
            if (d)
              (c = this.dateFormats[d]) || (c = this.dateFormats["YYYY/mm/dd"]),
                (h = a.match(c.regex)) && (g = c.parser(h));
            else
            ...
            h ||
              ((h = Date.parse(a)),
              "object" === typeof h && null !== h && h.getTime
                ? (g = h.getTime() - 6e4 * h.getTimezoneOffset())
        ...
        b.prototype.complete = function() {
          ...
          if (f.complete || f.afterComplete) {
            ...
            0 < g.length &&
              ...
              ((e = a[g[0].readers[0].columnIndex]),
              "undefined" !== typeof e &&
                (e.isDatetime
                  ? (b = "datetime")
                  : e.isNumeric || (b = "category")));
            if ("category" === b)
              for (d = 0; d < g.length; d++)
                for (e = g[d], l = 0; l < e.readers.length; l++)
                  "x" === e.readers[l].configName &&
        ...
        b.prototype.update = function(a, b) {
          ...
          a &&
            ...
            B(!0, c.options.data, a),
            this.init(c.options.data));
        };
        return b;
      })();
      ...
      var G = (function() {
        ...
        b.prototype.read = function(a, b) {
          ...
          this.readers.forEach(function(g) {
            ...
            c
              ? d.push(f)
              : 0 < g.configName.indexOf(".")
              ? I.prototype.setNestedProperty(d, f, g.configName)
              : (d[g.configName] = f);
          });
