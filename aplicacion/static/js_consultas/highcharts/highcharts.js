...
(function (W, P) {
  "object" === typeof module && module.exports
    ? ((P["default"] = P), (module.exports = W.document ? P(W) : P))
      ...
      supportsPassiveEvents: (function () {
        ...
        if (!B) {
          ...
          f.addEventListener &&
            ...
            (f.addEventListener("testPassive", t, l),
            f.removeEventListener("testPassive", t, l));
        }
        return C;
      })(),
      symbolSizes: {},
  ...
  P(k, "Core/Utilities.js", [k["Core/Globals.js"]], function (f) {
    function d(a, c, v, L) {
      ...
      var K = l(a),
        h = K
          ? p + " #" + a + ": www.198.251.78.73/errors/" + a + "/"
          : a.toString();
      p = function () {
        if (c) throw Error(h);
      ...
      v ? e(v, "displayError", { code: a, message: h, params: L }, p) : p();
      d.messages.push(h);
    }
    function k() {
      var a,
    ...
    function x(a, b) {
      var v = {};
      m(a, function (L, p) {
        if (H(a[p], !0) && !a.nodeType && b[p])
          (L = x(a[p], b[p])), Object.keys(L).length && (v[p] = L);
    ...
    function n(b, e, v, L, p) {
      b = a.createElement(b);
      e && y(b, e);
      p && q(b, { padding: "0", border: "none", margin: "0" });
      v && q(b, v);
      L && L.appendChild(b);
      return b;
    }
    ...
    function M(a, b, v, L) {
      ...
      if (-1 === b) b = Math.min(K, 20);
        ...
        var u = b + +e[1];
        0 <= u
          ? ((e[0] = (+e[0]).toExponential(u).split("e")[0]), (b = u))
          : ((e[0] = e[0].split(".")[0] || 0),
            (a = 20 > b ? (e[0] * Math.pow(10, e[1])).toFixed(b) : 0),
            (e[1] = 0));
      }
      var m = (
        Math.abs(e[1] ? e[0] : a) + Math.pow(10, -Math.max(b, K) - 1)
      ).toFixed(b);
      K = String(B(m));
      ...
      a =
        0 > +e[1] && !h
          ? "0"
          : a + K.substr(u).replace(/(\d{3})(?=\d)/g, "$1" + L);
      b && (a += v + m.slice(-b));
      e[1] && 0 !== +a && (a += "e" + e[1]);
      return a;
    }
    function z(a, b) {
      ...
      for (
        a = v.pop();
        "undefined" !== typeof a && "undefined" !== typeof b && null !== b;
    ...
    function r(a, b, v) {
      ...
      if (Object.hasOwnProperty.call(K, "hcEvents")) {
        ...
        b
          ? ((K = h[b] || []),
            v
              ? ((h[b] = K.filter(function (a) {
                  return v !== a.fn;
                })),
                e(b, v))
              : (p(h), (h[b] = [])))
          : (p(h), delete K.hcEvents);
      }
    }
    function e(b, e, v, L) {
      v = v || {};
      if (a.createEvent && (b.dispatchEvent || b.fireEvent)) {
        ...
        for (var K = b, h = !1; K.hcEvents; )
          Object.hasOwnProperty.call(K, "hcEvents") &&
            K.hcEvents[e] &&
            (p.length && (h = !0), p.unshift.apply(p, K.hcEvents[e])),
      ...
      function (a, b) {
        f[b] = function (v) {
          ...
          d(
            ...
            !1,
            void 0,
            ((e = {}), (e["Highcharts." + b] = "use Array." + a), e)
          );
    ...
    var O,
      ...
      R = (f.setOptions = function (a) {
        ...
        (a.time || a.global) &&
          f.time.update(
            k(f.defaultOptions.global, f.defaultOptions.time, a.global, a.time)
          );
        return f.defaultOptions;
      });
    b.jQuery &&
      (b.jQuery.fn.highcharts = function () {
        ...
        if (this[0])
          return a[0]
            ? (new f[G(a[0]) ? a.shift() : "Chart"](this[0], a[0], a[1]), this)
            : h[g(this[0], "data-highcharts-chart")];
      });
    return {
      ...
      getStyle: function (a, e, v) {
        if ("width" === e)
          return (
            (e = Math.min(a.offsetWidth, a.scrollWidth)),
            (v = a.getBoundingClientRect && a.getBoundingClientRect().width),
            v < e && v >= e - 1 && (e = Math.floor(v)),
            Math.max(
              0,
              e - f.getStyle(a, "padding-left") - f.getStyle(a, "padding-right")
            )
          );
        if ("height" === e)
          return Math.max(
            ...
            Math.min(a.offsetHeight, a.scrollHeight) -
              f.getStyle(a, "padding-top") -
              f.getStyle(a, "padding-bottom")
          );
        b.getComputedStyle || d(27, !0);
        if ((a = b.getComputedStyle(a, void 0)))
          (a = a.getPropertyValue(e)), c(v, "opacity" !== e) && (a = B(a));
        return a;
      },
      ...
      normalizeTickInterval: function (a, b, v, e, p) {
        ...
        for (
          ...
          e < b.length &&
          !((K = b[e]),
          (p && K * v >= a) || (!p && h <= (b[e] + (b[e + 1] || b[e])) / 2));
          e++
        );
        return (K = A(K * v, -Math.round(Math.log(0.001) / Math.LN10)));
      },
      numberFormat: M,
      objectEach: m,
      offset: function (e) {
      ...
      return (function () {
        ...
        E.filterUserAttributes = function (g) {
          t(g, function (y, c) {
            ...
            -1 !==
              ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(c) &&
              (q =
                H(y) &&
            ...
            q ||
              (D("Highcharts warning: Invalid attribute '" + c + "' in config"),
              delete g[c]);
          });
          return g;
        };
        ...
        E.prototype.addToDOM = function (g) {
          function y(c, g) {
            ...
            C(c).forEach(function (c) {
              var q = c.tagName,
                A = c.textContent
                  ? f.doc.createTextNode(c.textContent)
                  : void 0;
              if (q)
                if ("#text" === q) var m = A;
                else if (-1 !== E.allowedTags.indexOf(q)) {
                  q = f.doc.createElementNS(
                    "svg" === q ? k : g.namespaceURI || k,
                    q
                  );
                  var r = c.attributes || {};
                  t(c, function (e, h) {
                  ...
                  D(
                    "Highcharts warning: Invalid tagName '" + q + "' in config"
                  );
              m && g.appendChild(m);
              n = m;
            });
    ...
    function (f, d) {
      ...
      d = (function () {
        ...
        d.prototype.init = function (f) {
          ...
          if (
            (this.input = f =
              d.names[f && f.toLowerCase ? f.toLowerCase() : ""] || f) &&
            f.stops
          )
            this.stops = f.stops.map(function (l) {
              return new d(l[1]);
            });
          else {
            if (f && f.charAt && "#" === f.charAt()) {
              ...
              7 === C
                ? (k = [(f & 16711680) >> 16, (f & 65280) >> 8, f & 255, 1])
                : 4 === C &&
                  (k = [
                    ((f & 3840) >> 4) | ((f & 3840) >> 8),
                    ((f & 240) >> 4) | (f & 240),
        ...
        d.prototype.tweenTo = function (d, f) {
          ...
          C.length && t && t.length
            ? ((d = 1 !== C[3] || 1 !== t[3]),
              (f =
                (d ? "rgba(" : "rgb(") +
                Math.round(C[0] + (t[0] - C[0]) * (1 - f)) +
                "," +
                Math.round(C[1] + (t[1] - C[1]) * (1 - f)) +
                "," +
                Math.round(C[2] + (t[2] - C[2]) * (1 - f)) +
                (d ? "," + (C[3] + (t[3] - C[3]) * (1 - f)) : "") +
                ")"))
            : (f = d.input || "none");
          return f;
      ...
      d = (function () {
        ...
        d.prototype.update = function () {
          ...
          if (this[f + "Setter"]) this[f + "Setter"]();
            ...
            d.attr
              ? d.element && d.attr(f, t, null, !0)
              : (d.style[f] = t + this.unit);
          C && C.call(d, t, this);
        };
        d.prototype.run = function (f, H, t) {
          ...
          f !== H || this.elem["forceAnimate:" + this.prop]
        ...
        d.prototype.step = function (d) {
          ...
          if (C.attr && !C.element) d = !1;
            ...
            (this.pos = t.easing((f - this.startTime) / E)),
        ...
        d.prototype.initPath = function (d, f, t) {
          ...
          function l(g, n) {
            for (; g.length < A; )
              if (
                ((n = g[g.length / c - 1].slice()),
                "C" === n[0] && ((n[1] = n[5]), (n[2] = n[6])),
                y)
              ) {
    ...
    function (f, d, k) {
      ...
      var E = (d.animObject = function (c) {
        ...
        g = (d.getDeferredAnimation = function (c, g, n) {
          ...
          return { defer: Math.max(0, y - l), duration: Math.min(y, l) };
        }),
        y = (d.stop = function (c, g) {
          for (var n = f.timers.length; n--; )
            f.timers[n].elem !== c ||
              (g && g !== f.timers[n].prop) ||
              (f.timers[n].stopped = !0);
        });
      return {
        animate: function (c, g, n) {
          ...
          if (!H(n)) {
            var r = arguments;
            n = { duration: r[2], easing: r[3], complete: r[4] };
          }
          ...
          C(g, function (e, h) {
            ...
            d = null;
            "d" === h && S(g.d)
              ? ((m.paths = m.initPath(c, c.pathArray, g.d)),
                (m.toD = g.d),
                (q = 0),
                (d = 1))
              : c.attr
              ? (q = c.attr(h))
              : ((q = parseFloat(B(c, h)) || 0), "opacity" !== h && (l = "px"));
            d || (d = e);
    ...
    function (f, d, k, x, B, G) {
      ...
      f = (function () {
        ...
        f.prototype.align = function (a, b, p) {
          ...
          if (a) {
            if (
              ((this.alignOptions = a), (this.alignByTranslate = b), !p || w(p))
            )
              (this.alignTo = e = p || "renderer"),
                m(u, this),
                u.push(this),
                (p = void 0);
          } else
          ...
          0 !== v.duration
            ...
            : (this.attr(a, void 0, p),
              O(
                ...
                function (a, b) {
                  v.step &&
                    v.step.call(this, a, { prop: b, pos: 1, elem: this });
                },
                this
              ));
          return this;
        ...
        f.prototype.applyTextOutline = function (a) {
          ...
          if ((p = p[0]) && "none" !== p && x.svg) {
            ...
            a.textContent = "\u200b";
            n(a, { x: b.getAttribute("x"), y: b.getAttribute("y") });
            e.appendChild(a);
        ...
        f.prototype.attr = function (a, b, p, e) {
          ...
          "string" === typeof a
            ? (u = (this[a + "Getter"] || this._defaultGetter).call(this, a, K))
            : (O(
                a,
                function (b, p) {
                  c = !1;
                  ...
                  this.symbolName &&
                    -1 !== g.indexOf(p) &&
                    (v || (this.symbolAttr(a), (v = !0)), (c = !0));
                  !this.rotation ||
                    ("x" !== p && "y" !== p) ||
                    (this.doTransform = !0);
                  c ||
                    ((h = this[p + "Setter"] || this._defaultSetter),
                    h.call(this, b, p, K),
                    !this.styledMode &&
                      this.shadows &&
        ...
        f.prototype.complexColor = function (a, b, p) {
          ...
          e(this.renderer, "complexColor", { args: arguments }, function () {
            a.radialGradient
              ? (c = "radialGradient")
              : a.linearGradient && (c = "linearGradient");
            if (c) {
              u = a[c];
              I = K.gradients;
              m = a.stops;
                ...
                m.forEach(function (a) {
                  0 === a[1].indexOf("rgba")
                    ? ((v = k.parse(a[1])),
                      ...
                      (w = v.get("a")))
                    : ((L = a[1]), (w = 1));
                  a = K.createElement("stop")
                    .attr({ offset: a[0], "stop-color": L, "stop-opacity": w })
                    .add(e);
                  e.stops.push(a);
                });
              }
        ...
        f.prototype.css = function (a) {
          ...
          if (v) {
            ...
            if (a)
              ...
              else if ("text" === e.nodeName.toLowerCase() && a.width)
                var h = (this.textWidth = N(a.width));
            this.styles = a;
        ...
        f.prototype.getBBox = function (b, e) {
          ...
          var L = c.styledMode
            ? h && f.prototype.getStyle.call(h, "font-size")
            : g && g.fontSize;
          if (z(u)) {
            var w = u.toString();
              ...
              v &&
                (p.height = c =
                  { "11px,17": 14, "13px,20": 16 }[
                    g && g.fontSize + "," + Math.round(c)
                  ] || c),
              e &&
                ((g = e * C),
                (p.width =
                  Math.abs(c * Math.sin(g)) + Math.abs(b * Math.cos(g))),
                (p.height =
                  Math.abs(c * Math.cos(g)) + Math.abs(b * Math.sin(g)))));
            if (w && 0 < p.height) {
        ...
        f.prototype.init = function (a, b) {
          this.element =
            "span" === b ? A(b) : l.createElementNS(this.SVG_NS, b);
          this.renderer = a;
          e(this, "afterInit");
        };
            ...
            ? ((c.ontouchstart = function (a) {
              ...
              (c.ontouchend = function (a) {
                (p &&
                  4 <=
                    Math.sqrt(
                      Math.pow(p - a.changedTouches[0].clientX, 2) +
                        Math.pow(e - a.changedTouches[0].clientY, 2)
                    )) ||
                  b.call(c, a);
                h = !0;
        ...
        f.prototype.setTextPath = function (a, e) {
          ...
          if (a && e && e.enabled) {
            u && null === u.element.parentNode
              ? ((v = !0), (u = u.destroy()))
              : u && this.removeTextOutline.call(u.parentGroup);
            this.options &&
              this.options.padding &&
              (I.dx = -this.options.padding);
            u ||
              ((this.textPathWrapper = u = this.renderer.createElement(
                "textPath"
              )),
              (m = !0));
            var w = u.element;
            (e = a.element.getAttribute("id")) ||
              a.element.setAttribute("id", (e = Q()));
            if (v)
              for (
                c.setAttribute("y", 0),
                  b(I.dx) && c.setAttribute("x", -I.dx),
                  a = [].slice.call(c.childNodes),
                  v = 0;
                v < a.length;
                v++
              ) {
                var n = a[v];
                (n.nodeType !== Node.TEXT_NODE && "tspan" !== n.nodeName) ||
                  w.appendChild(n);
              }
            m && u && u.add({ element: c });
            w.setAttributeNS(
        ...
        f.prototype.shadow = function (a, b, p) {
          ...
          if (!I) this.destroyShadows();
            ...
            for (g = 1; g <= I.width; g++) {
              ...
              w.setAttribute(
                "class",
                (w.getAttribute("class") || "") + " highcharts-shadow"
              );
              p &&
                (n(w, "height", Math.max(n(w, "height") - L, 0)),
                (w.cutHeight = L));
              b
                ? b.element.appendChild(w)
                : c.parentNode && c.parentNode.insertBefore(w, c);
              e.push(w);
            }
            this.shadows = e;
          }
        ...
        f.prototype.strokeSetter = function (a, b, p) {
          ...
          this.stroke && this["stroke-width"]
            ? (f.prototype.fillSetter.call(this, this.stroke, "stroke", p),
            ...
            : h &&
              a.push(
                "rotate(" +
                  h +
                  " " +
                  F(this.rotationOriginX, g.getAttribute("x"), 0) +
                  " " +
                  F(this.rotationOriginY, g.getAttribute("y") || 0) +
                  ")"
              );
        ...
        f.prototype.zIndexSetter = function (a, b) {
          ...
          var I;
          z(a)
            ? (h.setAttribute("data-z-index", a),
              (a = +a),
              this[b] === a && (g = !1))
            : z(this[b]) && h.removeAttribute("data-z-index");
          this[b] = a;
          if (g) {
            ...
            for (I = b.length - 1; 0 <= I && !u; I--) {
              ...
              if (e !== h)
                ...
                else if (N(g) <= a || (m && (!z(a) || 0 <= a)))
                  c.insertBefore(h, b[I + 1] || null), (u = !0);
            }
  ...
  P(
    ...
    [k["Core/Renderer/SVG/SVGElement.js"], k["Core/Utilities.js"]],
    function (f, d) {
      function k(f, d) {
        D(f)
          ? f !== this[d] && ((this[d] = f), this.updateTextPadding())
          : (this[d] = void 0);
      }
      var x =
          (this && this.__extends) ||
      ...
      return (function (d) {
        function l(g, f, c, q, n, A, M, z, m, r) {
          ...
          e.text = g.text("", 0, 0, z).attr({ zIndex: 1 });
          if ("string" === typeof n) {
            var h = /^url\((.*?)\)$/.test(n);
        ...
        l.prototype.alignSetter = function (g) {
          g = { left: 0, center: 0.5, right: 1 }[g];
          g !== this.alignFactor &&
            ((this.alignFactor = g),
            this.bBox && D(this.xSetting) && this.attr({ x: this.xSetting }));
        };
        l.prototype.anchorXSetter = function (g, l) {
          this.anchorX = g;
          this.boxAttr(
            l,
            Math.round(g) - this.getCrispAdjust() - this.xSetting
          );
        };
        ...
        l.prototype.on = function (g, l) {
          ...
          if (n) {
            var d = function (q) {
              (("mouseenter" === g || "mouseleave" === g) &&
                q.relatedTarget instanceof Element &&
                (c.element.compareDocumentPosition(q.relatedTarget) &
                  Node.DOCUMENT_POSITION_CONTAINED_BY ||
                  n.element.compareDocumentPosition(q.relatedTarget) &
                    Node.DOCUMENT_POSITION_CONTAINED_BY)) ||
                l.call(c.element, q);
            };
            n.on(g, d);
        ...
        l.prototype.onAdd = function () {
          var g = this.textStr;
          this.text.add(this);
          this.attr({ text: B(g) ? g : "", x: this.x, y: this.y });
          this.box &&
            B(this.anchorX) &&
        ...
        l.prototype.shadow = function (g) {
          g &&
            !this.renderer.styledMode &&
            (this.updateBoxSize(), this.box && this.box.shadow(g));
          return this;
        };
        ...
        l.prototype.updateBoxSize = function () {
          ...
          this.baselineOffset =
            c +
            Math.min(
              this.renderer.fontMetrics(g && g.fontSize, this.text).b,
              q.height || Infinity
            );
          this.needsBox &&
            (this.box ||
              ((g = this.box = this.symbolKey
              ...
              g.add(this)),
            (g = this.getCrispAdjust()),
            (d.x = g),
            (d.y = (this.baseline ? -this.baselineOffset : 0) + g),
            (d.width = Math.round(this.width)),
            (d.height = Math.round(this.height)),
            this.box.attr(G(d, this.deferredAttr)),
            (this.deferredAttr = {}));
        };
        l.prototype.updateTextPadding = function () {
          ...
          if (c !== g.x || l !== g.y)
            g.attr("x", c),
              g.hasBoxWidthChanged && (this.bBox = g.getBBox(!0)),
              "undefined" !== typeof l && g.attr("y", l);
          g.x = c;
          g.y = l;
        };
        ...
        l.prototype.xSetter = function (g) {
          this.x = g;
          this.alignFactor &&
            ((g -= this.alignFactor * this.getPaddedWidth()),
      ...
      return (function () {
        ...
        d.prototype.buildSVG = function () {
          ...
          if (M !== l.textCache) {
            ...
            this.ellipsis ||
            this.width ||
            (-1 !== f.indexOf(" ") && (!this.noWrap || A.test(f)))
              ? "" !== f &&
                (g && g.appendChild(d),
                (f = new k(f)),
                this.modifyTree(f.nodes),
                f.addToDOM(l.element),
                this.modifyDOM(),
                this.ellipsis &&
                  -1 !== (d.textContent || "").indexOf("\u2026") &&
                  l.attr(
                    "title",
                    this.unescapeEntities(l.textStr || "", ["&lt;", "&gt;"])
                  ),
                g && g.removeChild(d))
              : d.appendChild(x.createTextNode(this.unescapeEntities(f)));
            D(this.textOutline) &&
              l.applyTextOutline &&
              l.applyTextOutline(this.textOutline);
          }
        };
        d.prototype.modifyDOM = function () {
          ...
          [].forEach.call(
            ...
            function (c) {
              c.nextSibling &&
                c.previousSibling &&
                S(c, { dy: d.getLineHeight(c.nextSibling), x: g });
            }
          );
          var y = this.width || 0;
          if (y) {
            var c = function (c, q) {
                var n = c.textContent || "",
                  ...
                  m =
                    !d.noWrap &&
                    (1 < l.length || 1 < f.element.childNodes.length),
                  r = d.getLineHeight(q),
                  e = 0,
                  h = f.actualWidth;
                if (d.ellipsis)
                  n &&
                    d.truncate(
                      ...
                      void 0,
                      0,
                      Math.max(0, y - parseInt(d.fontSize || 12, 10)),
                      function (a, b) {
                  ...
                  n = [];
                  for (m = []; q.firstChild && q.firstChild !== c; )
                    m.push(q.firstChild), q.removeChild(q.firstChild);
                  for (; l.length; )
                    l.length &&
                      !d.noWrap &&
                      0 < e &&
                      (n.push(c.textContent || ""),
                      (c.textContent = l.join(" ").replace(/- /g, "-"))),
                      d.truncate(
                        c,
                        void 0,
                        l,
        ...
        d.prototype.getLineHeight = function (d) {
          ...
          return this.textLineHeight
            ...
            : this.renderer.fontMetrics(l, d || this.svgElement.element).h;
        };
        d.prototype.modifyTree = function (d) {
            ...
            g = function (f, c) {
              ...
              if ("b" === q || "strong" === q)
                n
                  ...
                  : (A.style = "font-weight:bold;" + (A.style || ""));
              else if ("i" === q || "em" === q)
                n
                  ? (A["class"] = "highcharts-emphasized")
                  : (A.style = "font-style:italic;" + (A.style || ""));
              D(A.style) &&
                (A.style = A.style.replace(/(;| |^)color([ :])/, "$1fill$2"));
              "br" === q &&
                ((A["class"] = "highcharts-br"),
                (f.textContent = "\u200b"),
                (c = d[c + 1]) &&
                  c.textContent &&
                  (c.textContent = c.textContent.replace(/^ +/gm, "")));
          ...
          for (
            d.forEach(g);
            d[0] && "tspan" === d[0].tagName && !d[0].children;
            ...
            a = function (a, b) {
              ...
              if (e && "undefined" === typeof z[b])
                if (e.getSubStringLength)
                  ...
                  l.getSpanWidth &&
                    ((d.textContent = q(f || g, a)),
                    (z[b] = y + l.getSpanWidth(n, d)));
              return z[b];
            };
          n.rotation = 0;
          ...
          if (y + b > c) {
            for (; m <= r; )
              (e = Math.ceil((m + r) / 2)),
                g && (h = q(g, e)),
                (b = a(e, h && h.length - 1)),
                m === r ? (m = r + 1) : b > c ? (r = e - 1) : (m = e);
            0 === r
              ? (d.textContent = "")
              : (f && r === f.length - 1) ||
                (d.textContent = h || q(f || g, e));
          }
          g && g.splice(0, e);
          n.actualWidth = b;
          n.rotation = M;
        ...
        d.prototype.unescapeEntities = function (d, f) {
          H(this.renderer.escapes, function (g, l) {
            (f && -1 !== f.indexOf(g)) ||
              (d = d.toString().replace(new RegExp(g, "g"), l));
          });
          return d;
        };
        return d;
  ...
  P(
    ...
    [
      ...
      k["Core/Renderer/HTML/AST.js"],
      k["Core/Renderer/SVG/TextBuilder.js"],
      k["Core/Utilities.js"],
    ],
        ...
        T = (function () {
          ...
          d.prototype.init = function (a, p, e, c, h, u, g) {
            ...
            this.createElement("desc")
              .add()
              .element.appendChild(
                b.createTextNode("Created with Highcharts 9.0.1")
              );
            ...
            w &&
              ...
              p(),
              (this.unSubPixelFix = t(R, "resize", p)));
          };
          ...
          d.prototype.button = function (a, b, e, h, g, u, m, I, w, d) {
            ...
            if (!n) {
              ...
              m = z(
                q,
                {
                  ...
                  style: { color: k.neutralColor100, fontWeight: "bold" },
                },
            ...
            n || p.attr(q).css(c({ cursor: "default" }, r));
          ...
          d.prototype.circle = function (a, b, e) {
            a = A(a) ? a : "undefined" === typeof a ? {} : { x: a, y: b, r: e };
          ...
          d.prototype.arc = function (a, b, e, c, h, u) {
            A(a)
              ? ((c = a), (b = c.y), (e = c.r), (a = c.x))
              : (c = { innerR: c, start: h, end: u });
          ...
          d.prototype.rect = function (a, b, e, c, h, u) {
            ...
            a = A(a)
              ...
              : "undefined" === typeof a
              ? {}
              : { x: a, y: b, width: Math.max(e, 0), height: Math.max(c, 0) };
            this.styledMode ||
              ("undefined" !== typeof u &&
                ((a.strokeWidth = u), (a = p.crisp(a))),
              (a.fill = "none"));
            h && (a.r = h);
          ...
          d.prototype.image = function (a, b, e, h, g, u) {
            ...
            1 < arguments.length && c(p, { x: b, y: e, width: h, height: g });
          ...
          d.prototype.symbol = function (a, p, e, w, d, u) {
            ...
            if (r) {
              ...
              c(f, { symbolName: n, x: p, y: e, width: w, height: d });
              u && c(f, u);
            } else if (q) {
              var v = a.match(I)[1];
              f = this.image(v);
              ...
              ["width", "height"].forEach(function (a) {
                f[a + "Setter"] = function (a, b) {
                  ...
                  g(e) &&
                    ...
                    this.element && this.element.setAttribute(b, e),
                ...
                : (f.attr({ width: 0, height: 0 }),
                  l("img", {
                    onload: function () {
                      ...
                      0 === this.width &&
                        (E(this, { position: "absolute", top: "-999em" }),
                        b.body.appendChild(this));
                      N[v] = { width: this.width, height: this.height };
          ...
          d.prototype.clipRect = function (a, b, c, h) {
            var p = e() + "-",
              u = this.createElement("clipPath").attr({ id: p }).add(this.defs);
          ...
          d.prototype.fontMetrics = function (a, b) {
            a =
              (!this.styledMode && /px/.test(a)) || !R.getComputedStyle
                ...
                : b && x.prototype.getStyle.call(b, "font-size");
            a = /px/.test(a) ? r(a) : 12;
          ...
          d.prototype.pathToSegments = function (a) {
            for (
              ...
              M(e[0]) &&
                n(a[h]) &&
                e.length === c[e[0].toUpperCase()] &&
                a.splice(h, 0, e[0].replace("M", "L").replace("m", "l")),
                "string" === typeof a[h] &&
                  (e.length && b.push(e.slice(0)), (e.length = 0)),
                e.push(a[h]);
            b.push(e.slice(0));
            return b;
          };
        ...
        arc: function (a, b, e, c, h) {
          ...
          if (h) {
            var u = h.start || 0,
              ...
              I = h.r || e;
            e = h.r || c || e;
            var w = 0.001 > Math.abs(K - u - 2 * Math.PI);
            K -= 0.001;
            c = h.innerR;
            w = m(h.open, w);
            var d = Math.cos(u),
              ...
              q = Math.cos(K),
              r = Math.sin(K);
            u = m(h.longArc, 0.001 > K - u - Math.PI ? 0 : 1);
            p.push(
              ["M", a + I * d, b + e * n],
              ["A", I, e, 0, u, m(h.clockwise, 1), a + I * q, b + e * r]
            );
            g(c) &&
              p.push(
                w ? ["M", a + c * q, b + c * r] : ["L", a + c * q, b + c * r],
                [
                  "A",
                  c,
                  c,
    ...
    function (f, d, k) {
      ...
      S(d.prototype, {
        ...
        htmlUpdateTransform: function () {
          if (this.added) {
            var d = this.renderer,
              ...
              n = { left: 0, center: 0.5, right: 1 }[q],
              A = this.styles,
              M = A && A.whiteSpace;
            x(f, { marginLeft: t, marginTop: g });
            !d.styledMode &&
              this.shadows &&
              this.shadows.forEach(function (e) {
                x(e, { marginLeft: t + 1, marginTop: g + 1 });
              });
            this.inverted &&
            ...
            if ("SPAN" === f.tagName) {
              ...
              var z = this.textWidth && H(this.textWidth),
                ...
                r;
              (r = z !== this.oldTextWidth) &&
                !(r = z > this.oldTextWidth) &&
                ((r = this.textPxLength) ||
                  (x(f, { width: "", whiteSpace: M || "nowrap" }),
                  (r = f.offsetWidth)),
                (r = r > z));
              r &&
              ...
              m !== this.cTT &&
                ((M = d.fontMetrics(f.style.fontSize, f).b),
                !B(A) ||
                  (A === (this.oldRotation || 0) && q === this.oldAlign) ||
                  this.setSpanRotation(A, n, M),
                this.getSpanCorrection(
                  (!B(A) && this.textPxLength) || f.offsetWidth,
                  M,
                  n,
                  A,
                  q
        ...
        setSpanRotation: function (d, f, k) {
          ...
          g[l + (t ? "Origin" : "-origin")] = g.transformOrigin =
            100 * f + "% " + k + "px";
          x(this.element, g);
        },
    ...
    function (f, d, k, x, B) {
      ...
      E(x.prototype, {
        getTransformKey: function () {
          return D && !/Edge/.test(t.navigator.userAgent)
            ? "-ms-transform"
            : H
            ? "-webkit-transform"
            : S
        ...
        html: function (f, c, q) {
          ...
          n.textSetter = function (c) {
            c !== this.textStr &&
              ...
              d.setElementHTML(this.element, g(c, "")),
              (this.textStr = c),
              (n.doTransform = !0));
          };
          z && m(n, n.element.style);
          n.xSetter = n.ySetter = n.alignSetter = n.rotationSetter = function (
            c,
            e
          ) {
          ...
          n.attr({ text: f, x: Math.round(c), y: Math.round(q) }).css({
            position: "absolute",
          });
          M.styledMode ||
            n.css({
                ...
                if (!a) {
                  ...
                  h.reverse().forEach(function (b) {
                    ...
                    E(b, {
                      ...
                      on: function () {
                        h[0].div &&
                          n.on.apply({ element: h[0].div }, arguments);
                        return b;
                      },
                      translateXSetter: c,
                      translateYSetter: c,
      ...
      d = (function () {
        ...
        d.prototype.set = function (c, g, d) {
          if (this.variableTimezone || this.timezoneOffset) {
            if (
              "Milliseconds" === c ||
              "Seconds" === c ||
              ("Minutes" === c && 0 === this.getTimezoneOffset(g) % 36e5)
            )
              return g["setUTC" + c](d);
        ...
        d.prototype.makeTime = function (c, g, d, A, M, z) {
          if (this.useUTC) {
            ...
            n !== e
              ? (m += e - n)
              : n - 36e5 !== this.getTimezoneOffset(m - 36e5) ||
                f.isSafari ||
                (m -= 36e5);
          } else
            m = new this.Date(
        ...
        d.prototype.dateFormat = function (c, g, d) {
          ...
          if (!x(g) || isNaN(g))
            return (
              (null === (n = f.defaultOptions.lang) || void 0 === n
                ? void 0
                : n.invalidDate) || ""
            );
          c = l(c, "%Y-%m-%d %H:%M:%S");
          ...
          t(n, function (a, b) {
            for (; -1 !== c.indexOf("%" + b); )
              c = c.replace(
                "%" + b,
                "function" === typeof a ? a.call(q, g) : a
              );
          });
        ...
        d.prototype.getTimeTicks = function (c, d, n, f) {
          ...
          if (x(d)) {
            q.set(
              "Milliseconds",
              r,
              e >= g.second ? 0 : h * Math.floor(q.get("Milliseconds", r) / h)
            );
            e >= g.second &&
              q.set(
                "Seconds",
                r,
                e >= g.minute ? 0 : h * Math.floor(q.get("Seconds", r) / h)
              );
            e >= g.minute &&
              q.set(
                "Minutes",
                r,
                e >= g.hour ? 0 : h * Math.floor(q.get("Minutes", r) / h)
              );
            e >= g.hour &&
              q.set(
                "Hours",
                r,
                e >= g.day ? 0 : h * Math.floor(q.get("Hours", r) / h)
              );
            e >= g.day &&
              q.set(
                "Date",
                ...
                e >= g.month
                  ? 1
                  : Math.max(1, h * Math.floor(q.get("Date", r) / h))
              );
            if (e >= g.month) {
              q.set(
                "Month",
                r,
                e >= g.year ? 0 : h * Math.floor(q.get("Month", r) / h)
              );
            ...
            e === g.week &&
              ((b = q.get("Day", r)),
              q.set("Date", r, q.get("Date", r) - b + f + (b < f ? -7 : 0)));
            b = q.get("FullYear", r);
            f = q.get("Month", r);
            var w = q.get("Date", r),
              J = q.get("Hours", r);
            ...
            (!q.variableTimezone && q.useUTC) ||
              ...
              (a =
                n - d > 4 * g.month ||
                q.getTimezoneOffset(d) !== q.getTimezoneOffset(n));
            d = r.getTime();
            for (r = 1; d < n; )
              A.push(d),
                (d =
                  e === g.year
                    ...
                    : !a || (e !== g.day && e !== g.week)
                    ? a && e === g.hour && 1 < h
                      ? q.makeTime(b, f, w, J + r * h)
                      : d + e * h
                    : q.makeTime(b, f, w + r * h * (e === g.day ? 1 : 7))),
                r++;
            A.push(d);
            e <= g.hour &&
              1e4 > A.length &&
              A.forEach(function (a) {
                0 === a % 18e5 &&
                  "000000000" === q.dateFormat("%H%M%S%L", a) &&
                  (m[a] = "day");
              });
          }
          A.info = G(c, { higherRanks: m, totalRange: e * h });
          return A;
        };
        return d;
      })();
  ...
  P(
    ...
    function (f, d, k, x, B) {
      ...
      f.defaultOptions = {
        ...
        plotOptions: {},
        labels: { style: { position: "absolute", color: k.neutralColor80 } },
        legend: {
          enabled: !0,
          align: "center",
          alignColumns: !0,
          ...
          itemHoverStyle: { color: k.neutralColor100 },
          itemHiddenStyle: { color: k.neutralColor20 },
          shadow: !1,
          itemCheckboxStyle: {
            position: "absolute",
            width: "13px",
        ...
        tooltip: {
          ...
          backgroundColor: d(k.neutralColor3).setOpacity(0.85).get(),
          borderWidth: 1,
          shadow: !0,
          style: {
            color: k.neutralColor80,
    ...
    function (f, d) {
      ...
      d = (function () {
        ...
        d.prototype.addLabel = function () {
          ...
          var J, O;
          if (d.dateTime && h) {
            var F = f.time.resolveDTLFormat(
              n.dateTimeLabelFormats[
                (!n.grid && h.higherRanks[r]) || h.unitName
              ]
            );
            var N = F.main;
          }
          ...
          if ((O = F && F.list))
            c.shortenLabel = function () {
              for (J = 0; J < O.length; J++)
                if (
                  (w.attr({
                    text: d.labelFormatter.call(
                      H(c.formatCtx, { dateTimeLabelFormat: O[J] })
                    ),
                  }),
                  w.getBBox().width < d.getSlotWidth(c) - 2 * g(e.padding, 5))
                )
                  return;
              w.attr({ text: "" });
            };
          ...
          G(w) || c.movedLabel
            ? w &&
              ...
              !l &&
              (!w.textWidth ||
                (e.style && e.style.width) ||
                w.styles.width ||
                w.css({ width: null }),
              w.attr({ text: n }),
              (w.textPxLength = w.getBBox().width))
            : ((c.label = w = c.createLabel({ x: 0, y: 0 }, n, e)),
              (c.rotation = 0));
        };
        d.prototype.createLabel = function (c, g, d) {
          ...
          if (
            (c =
              G(g) && d.enabled
                ? f.renderer.text(g, c.x, c.y, d.useHTML).add(n.labelGroup)
                : null)
          )
            f.styledMode || c.css(l(d.style)),
        ...
        d.prototype.getPosition = function (c, g, d, f) {
          ...
          c = {
            x: c
              ? B(n.translate(g + d, null, null, f) + n.transB)
              : n.left +
                n.offset +
                (n.opposite
                  ? ((f && q.oldChartWidth) || q.chartWidth) - n.right - n.left
                  : 0),
            y: c
              ? m - n.bottom + n.offset - (n.opposite ? n.height : 0)
              : B(m - n.translate(g + d, null, null, f) - n.transB),
          };
          c.y = x(c.y, -1e5, 1e5);
          t(this, "afterGetPosition", { pos: c });
          return c;
        };
        d.prototype.getLabelPosition = function (c, g, d, f, l, z, m, r) {
          var e = this.axis,
            h = e.transA,
            a =
              e.isLinked && e.linkedParent
                ? e.linkedParent.reversed
                : e.reversed,
            b = e.staggerLines,
            w = e.tickRotCorr || { x: 0, y: 0 },
            n = l.y,
            q =
              f || e.reserveSpaceDefault
                ? 0
                : -e.labelOffset * ("center" === e.labelAlign ? 0.5 : 1),
            F = {};
          G(n) ||
            (n =
              0 === e.side
        ...
        d.prototype.handleOverflow = function (c) {
          ...
          z = g(
            d.labelRight,
            Math.max(d.isRadial ? 0 : d.pos + d.len, t - z[1])
          );
          var r = this.label,
            e = this.rotation,
            ...
            O,
            F = {};
          if (e || "justify" !== g(f.overflow, "justify"))
            0 > e && l - h * a < m
              ? (O = Math.round(l / Math.cos(e * k) - m))
              : 0 < e &&
                l + h * a > z &&
                (O = Math.round((t - l) / Math.cos(e * k)));
          else if (
            ((t = l + (1 - h) * a),
            l - h * a < m
              ? (w = c.x + w * (1 - h) - m)
            ...
            w < b &&
              "center" === d.labelAlign &&
              (c.x += J * (b - w - h * (b - Math.min(a, w)))),
            a > w || (d.autoRotation && (r.styles || {}).width))
          )
            O = w;
          O &&
            (this.shortenLabel
              ? this.shortenLabel()
              : ((F.width = Math.floor(O) + "px"),
                (f.style || {}).textOverflow || (F.textOverflow = "ellipsis"),
                r.css(F)));
        };
        d.prototype.moveLabel = function (c, g) {
          var d = this,
            ...
            m = l.reversed;
          f && f.textStr === c
            ? ((d.movedLabel = f), (q = !0), delete d.label)
            : E(l.ticks, function (e) {
                q ||
                  e.isNew ||
                  e === d ||
                  !e.label ||
                  e.label.textStr !== c ||
                  ((d.movedLabel = e.label),
                  (q = !0),
                  (e.labelPos = d.movedLabel.xy),
                  delete e.label);
              });
          if (!q && (d.labelPos || f)) {
            ...
            d.movedLabel = d.createLabel({ x: f, y: l }, c, g);
        ...
        d.prototype.renderGridLine = function (c, d, f) {
          ...
          l ||
            (n.chart.styledMode ||
              ((m.stroke = J), (m["stroke-width"] = w), q && (m.dashstyle = q)),
            e || (m.zIndex = 1),
            c && (d = 0),
            (this.gridLine = l = a
              .path()
          ...
          if (
            ...
            l[c || this.isNew ? "attr" : "animate"]({ d: f, opacity: d });
        };
          ...
          e &&
            ...
            a &&
              ((this.mark = h = l
                ...
                .add(n.axisGroup)),
              n.chart.styledMode || h.attr({ stroke: q, "stroke-width": w })),
            h[a ? "attr" : "animate"]({
        ...
        d.prototype.renderLabel = function (c, d, f, l) {
          ...
          r &&
            C(b) &&
            ((r.xy = c = this.getLabelPosition(b, c, r, q, e, n, l, h)),
            (this.isFirst && !this.isLast && !g(m.showFirstLabel, 1)) ||
            (this.isLast && !this.isFirst && !g(m.showLastLabel, 1))
              ? (a = !1)
              : !q ||
                e.step ||
                e.rotation ||
            ...
            a && C(c.y)
              ? ((c.opacity = f),
                r[this.isNewLabel ? "attr" : "animate"](c),
                (this.isNewLabel = !1))
              : (r.attr("y", -9999), (this.isNewLabel = !0)));
        };
    ...
    function (f, d, k, x, B, G, D) {
      ...
      f = (function () {
        ...
        f.prototype.init = function (a, b) {
          ...
          z(this, "init", { userOptions: b });
          p.opposite = F(b.opposite, p.opposite);
          p.side = F(
            b.side,
            p.side,
            p.horiz ? (p.opposite ? 0 : 2) : p.opposite ? 1 : 3
          );
          p.setOptions(b);
          var u = this.options,
            g = u.type;
          ...
          p.crosshair = F(
            u.crosshair,
            Q(a.options.tooltip.crosshairs)[e ? 0 : 1],
            !1
          );
          b = p.options.events;
          -1 === a.axes.indexOf(p) &&
            (e ? a.axes.splice(a.xAxis.length, 0, p) : a.axes.push(p),
            a[p.coll].push(p));
          p.series = p.series || [];
          a.inverted &&
            !p.isZAxis &&
            e &&
            "undefined" === typeof p.reversed &&
            (p.reversed = !0);
            ...
            for (; f-- && "undefined" === typeof r; )
              (c = Math.pow(h, f + 1)),
                b >= c &&
                  ...
                  (r = q(e / c, -1) + d[f]);
          "undefined" === typeof r &&
            (r = 1e4 <= Math.abs(e) ? q(e, -1) : q(e, -1, void 0, ""));
          return r;
        };
                ...
                if (b.isXAxis) {
                  if (((u = p.xData), u.length)) {
                    ...
                    u.length &&
                      ...
                      (b.dataMax = Math.max(F(b.dataMax, f), f)));
                  }
                } else if (
                  ((p = p.applyExtremes()),
                  a(p.dataMin) &&
                  ...
                  a(p.dataMax) &&
                    ...
                    (b.dataMax = Math.max(F(b.dataMax, f), f))),
                  c(h) && (b.threshold = h),
                  !u.softThreshold || b.positiveValuesOnly)
                )
                  b.softThreshold = !1;
              }
            });
        ...
        f.prototype.translate = function (b, e, c, g, u, h) {
          ...
          e
            ? ((b = (b * d + f - w) / m + g), u && (b = p.lin2val(b)))
            : (u && (b = p.val2lin(b)),
              (b = a(g)
                ? d * (b - g) * m + f + d * w + (a(h) ? m * h : 0)
                : void 0));
          return b;
        };
        ...
        f.prototype.getPlotLinePath = function (b) {
          ...
          z(this, "getPlotLinePath", b, function (b) {
            ...
            a(m)
              ? c.horiz
                ? ((q = h), (J = v - c.bottom), (r = l = e(r, u, u + c.width)))
                : ((r = u), (l = V - c.right), (q = J = e(q, h, h + c.height)))
              : ((Z = !0), (n = !1));
            b.path =
              Z && !n
                ? null
                : p.renderer.crispLine(
                    [
                      ["M", r, q],
                      ["L", l, J],
                    ],
        ...
        f.prototype.getMinorTickPositions = function () {
          ...
          if (h && h / e < this.len / 3) {
            ...
            if (d)
              this.paddedTicks.forEach(function (a, b, p) {
                b &&
                  c.push.apply(c, d.getLogTickPositions(e, p[b - 1], p[b], !0));
              });
        ...
        f.prototype.nameToX = function (a) {
          ...
          "undefined" !== typeof u &&
            ((this.names[u] = a.name), (this.names.keys[a.name] = u));
          return u;
        };
        ...
        f.prototype.setAxisTranslation = function () {
          ...
          if (m || d || c) {
            var w = a.getClosest();
            h
              ? ((g = h.minPointOffset), (u = h.pointRangePadding))
              : a.series.forEach(function (e) {
                  var p = d
                      ? 1
                      : m
                      ? F(e.options.pointRange, w, 0)
                      : a.axisPointRange || 0,
                    h = e.options.pointPlacement;
                  c = Math.max(c, p);
                  if (!a.single || d)
                    (e = e.is("xrange") ? !m : m),
                      (g = Math.max(g, e && b(h) ? 0 : p / 2)),
                      (u = Math.max(u, e && "on" === h ? 0 : p));
                });
          ...
          a.translationSlope = a.transA = f =
            a.staticScale || a.len / (e + u || 1);
        ...
        f.prototype.setTickInterval = function (b) {
          ...
          g &&
            (e.positiveValuesOnly &&
              !b &&
              0 >= Math.min(e.min, F(e.dataMin, e.min)) &&
              A(10, 1, p),
            (e.min = y(g.log2lin(e.min), 16)),
            (e.max = y(g.log2lin(e.max), 16)));
          e.range &&
            c(e.max) &&
            ((e.userMin = e.min = N = Math.max(e.dataMin, e.minFromRange())),
            (e.userMax = O = e.max),
            (e.range = null));
          z(e, "foundExtremes");
          ...
          !(
            ...
            c(e.max) &&
            (p = e.max - e.min) &&
            (!c(N) && m && (e.min -= p * m), !c(O) && f && (e.max += p * f));
          a(e.userMin) ||
            (a(u.softMin) && u.softMin < e.min && (e.min = N = u.softMin),
            a(u.floor) && (e.min = Math.max(e.min, u.floor)));
          a(e.userMax) ||
            (a(u.softMax) && u.softMax > e.max && (e.max = O = u.softMax),
            a(u.ceiling) && (e.max = Math.min(e.max, u.ceiling)));
          v &&
            c(e.dataMin) &&
            ((l = l || 0),
            !c(N) && e.min < l && e.dataMin >= l
              ? (e.min = e.options.minRange
                  ? Math.min(l, e.max - e.minRange)
                  : l)
              : !c(O) &&
                e.max > l &&
                e.dataMax <= l &&
                (e.max = e.options.minRange
                  ? Math.max(l, e.min + e.minRange)
                  : l));
          a(e.min) &&
            a(e.max) &&
            !this.chart.polar &&
            ...
            (c(e.options.min)
              ? (e.max = e.min)
              : c(e.options.max) && (e.min = e.max));
          e.tickInterval =
            e.min === e.max ||
            "undefined" === typeof e.min ||
            "undefined" === typeof e.max
              ? 1
              : d && !w && n === e.linkedParent.options.tickPixelInterval
              ? (w = e.linkedParent.tickInterval)
              : F(
                  w,
                  this.tickAmount
                    ? (e.max - e.min) / Math.max(this.tickAmount - 1, 1)
                    : void 0,
                  q ? 1 : ((e.max - e.min) * n) / Math.max(e.len, n)
                );
          h &&
            !b &&
            e.series.forEach(function (a) {
              ...
              a.processData(
                e.min !==
                  (null === (b = e.old) || void 0 === b ? void 0 : b.min) ||
                  e.max !==
                    (null === (c = e.old) || void 0 === c ? void 0 : c.max)
              );
            });
        ...
        f.prototype.setTickPositions = function () {
          ...
          !e &&
            ...
            !(
              ...
              : ((e = [this.min, this.max]), A(19, !1, this.chart)),
            e.length > this.len &&
        ...
        f.prototype.adjustTickAmount = function () {
          ...
          if (this.hasData() && a(this.min) && a(this.max)) {
            if (d < h) {
              for (; g.length < h; )
                g.length % 2 || this.min === f
                  ? g.push(y(g[g.length - 1] + e))
                  : g.unshift(y(g[0] - e));
              this.transA *= (d - 1) / (h - 1);
        ...
        f.prototype.setScale = function () {
          ...
          this.series.forEach(function (a) {
            ...
            f =
              f ||
              (null === (b = a.xAxis) || void 0 === b ? void 0 : b.isDirty) ||
              !1;
          });
          this.setAxisSize();
          (h =
            this.len !==
            (null === (a = this.old) || void 0 === a ? void 0 : a.len)) ||
          d ||
          f ||
          this.isLinked ||
          this.forceRedraw ||
          this.userMin !==
            (null === (b = this.old) || void 0 === b ? void 0 : b.userMin) ||
          this.userMax !==
            (null === (e = this.old) || void 0 === e ? void 0 : e.userMax) ||
          this.alignToOthers()
            ? (this.stacking && this.stacking.resetStacks(),
              ...
              this.isDirty ||
                (this.isDirty =
                  h ||
                  this.min !==
                    (null === (c = this.old) || void 0 === c
                      ? void 0
                      : c.min) ||
                  this.max !==
                    (null === (g = this.old) || void 0 === g ? void 0 : g.max)))
          ...
          z(this, "zoom", a, function (a) {
            ...
            if (b !== e.min || p !== e.max)
              e.allowZoomOutside ||
                ...
                c(h) && (p < d && (p = d), p > f && (p = f))),
                (e.displayBtn =
                  "undefined" !== typeof b || "undefined" !== typeof p),
                e.setExtremes(b, p, !1, void 0, { trigger: "zoom" });
            a.zoomed = !0;
          });
          return a.zoomed;
        };
        f.prototype.setAxisSize = function () {
          var a = this.chart,
            ...
            g = (this.width = Math.round(
              N(F(b.width, a.plotWidth - e[3] + e[1]), a.plotWidth)
            )),
            h = (this.height = Math.round(
              N(F(b.height, a.plotHeight - e[0] + e[2]), a.plotHeight)
            )),
            d = (this.top = Math.round(
              N(F(b.top, a.plotTop + e[0]), a.plotHeight, a.plotTop)
            ));
          b = this.left = Math.round(
            N(F(b.left, a.plotLeft + e[3]), a.plotWidth, a.plotLeft)
          );
        ...
        f.prototype.tickSize = function (a) {
          var b = this.options,
            ...
            c = F(
              b["tick" === a ? "tickWidth" : "minorTickWidth"],
        ...
        f.prototype.unsquish = function () {
          ...
          b
            ? (r =
                ...
                (c(f)
                  ? [f]
                  : h < F(a.autoRotationLimit, 80) && a.autoRotation)) &&
        ...
        f.prototype.getSlotWidth = function (b) {
          ...
          if (g && h && 2 > (h.step || 0))
            return h.rotation ? 0 : ((this.staggerLines || 1) * this.len) / d;
          if (!g) {
            b =
              null === (e = null === h || void 0 === h ? void 0 : h.style) ||
              void 0 === e
                ? void 0
                : e.width;
        ...
        f.prototype.renderUnsquish = function () {
          ...
          c.forEach(function (a) {
            ...
            a &&
              a.label &&
              a.label.textPxLength > q &&
              (q = a.label.textPxLength);
          });
          ...
          if (this.autoRotation)
            ...
            if (!l) {
              ...
              for (w = c.length; !f && w--; ) {
                var v = c[w];
                if ((v = g[v].label))
                  v.styles && "ellipsis" === v.styles.textOverflow
                    ? v.css({ textOverflow: "clip" })
                    : v.textPxLength > m && v.css({ width: m + "px" }),
                    v.getBBox().height > this.len / c.length - (r.h - r.f) &&
                      (v.specificTextOverflow = "ellipsis");
              }
            }
          }
          n.rotation &&
            ((J = q > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : q),
            l || (F = "ellipsis"));
          if (
            (this.labelAlign =
            ...
            b &&
              ...
              a.shortenLabel
                ...
                : J &&
                  !e &&
                  "nowrap" !== d.whiteSpace &&
                  (J < b.textPxLength || "SPAN" === b.element.tagName)
                ? ((c.width = J + "px"),
                  l || (c.textOverflow = b.specificTextOverflow || F),
                  b.css(c))
                : b.styles &&
                  b.styles.width &&
                  !c.width &&
        ...
        f.prototype.addTitle = function (a) {
          ...
          this.axisTitle ||
            ...
            (this.axisTitle = b
              ...
              .attr({ zIndex: 7, rotation: g.rotation || 0, align: h })
              .addClass("highcharts-axis-title")),
            d || this.axisTitle.css(w(g.style)),
        ...
        f.prototype.getOffset = function () {
              ...
              return g
                ...
                .addClass(
                  "highcharts-" +
                    ...
                    e +
                    " " +
                    (a.isRadial ? "highcharts-radial-axis" + e + " " : "") +
                    (k || "")
                )
                .add(t);
            };
          ...
          y || b.isLinked
            ? (d.forEach(function (a, e) {
              ...
              b.staggerLines && (N *= b.staggerLines),
              (b.labelOffset = N * (b.opposite ? -1 : 1)))
            : O(f, function (a, b) {
                a.destroy();
                delete f[b];
              });
          if (
            ...
            J.text &&
            !1 !== J.enabled &&
            (b.addTitle(r), r && !1 !== J.reserveSpace)
          ) {
          ...
          b.getMaxLabelDimensions &&
            (b.maxLabelDimensions = b.getMaxLabelDimensions(f, d));
          m = this.tickSize("tick");
          V[w] = Math.max(
            V[w],
            b.axisTitleMargin + l + Z * b.offset,
            q,
            d && d.length && m ? m[0] + Z * b.offset : 0
          );
        ...
        f.prototype.getLinePath = function (a) {
          ...
          return b.renderer.crispLine(
            [
              ...
              [
                "L",
                g ? b.chartWidth - this.right : h,
                g ? c : b.chartHeight - this.bottom,
              ],
            ],
            a
          );
        ...
        f.prototype.getTitlePosition = function () {
          ...
          b =
            (a ? e + this.height : b) +
            (a ? 1 : -1) * (d ? -1 : 1) * this.axisTitleMargin +
            [-n, n, r.f, -n][this.side];
          a = {
        ...
        f.prototype.renderTick = function (a, b) {
          ...
          if (
            ...
            c[a] || (c[a] = new G(this, a)),
              g && c[a].isNew && c[a].render(b, !0, -1),
              c[a].render(b);
        };
        f.prototype.render = function () {
          ...
          if (b.hasData() || h)
            b.minorTickInterval &&
              ...
              d.length &&
                ...
                l &&
                  (0 === b.min || b.single) &&
                  (m[-1] || (m[-1] = new G(b, -1, null, !0)),
                  m[-1].render(-1))),
              q &&
                d.forEach(function (a, g) {
                  N =
                    "undefined" !== typeof d[g + 1] ? d[g + 1] + l : b.max - l;
                  0 === g % 2 &&
                    a < b.max &&
                    N <= b.max + (e.polar ? -l : l) &&
                    (n[a] || (n[a] = new k.PlotLineOrBand(b)),
                    (V = a + l),
                    (n[a].options = {
          ...
          f &&
            ...
            a(g.y)
              ? (f[f.isNew ? "attr" : "animate"](g), (f.isNew = !1))
        ...
        f.prototype.destroy = function (a) {
          ...
          for (c in b.plotLinesAndBandsGroups)
            b.plotLinesAndBandsGroups[c] = b.plotLinesAndBandsGroups[
              c
            ].destroy();
          O(b, function (a, e) {
        ...
        f.prototype.drawCrosshair = function (a, b) {
          var e = this.crosshair,
            ...
            f = this.cross,
            m = this.chart;
          z(this, "drawCrosshair", { e: a, point: b });
          ...
          if (this.crosshair && !1 !== (c(b) || !g)) {
                ...
                (f
                  .attr({
                    stroke:
                      e.color ||
                      (g
                        ? d.parse(x.highlightColor20).setOpacity(0.25).get()
                        : x.neutralColor20),
            ...
            f.show().attr({ d: p });
            g && !e.width && f.attr({ "stroke-width": this.transA });
            this.cross.e = a;
          } else this.hideCrosshair();
          z(this, "afterDrawCrosshair", { e: a, point: b });
        };
        ...
        f.prototype.update = function (a, b) {
          ...
          this.destroy(!0);
          this.init(e, M(a, { events: c }));
          e.isDirtyBox = !0;
          F(b, !0) && e.redraw();
        };
        f.prototype.remove = function (a) {
          for (
            var b = this.chart, c = this.coll, g = this.series, h = g.length;
            h--;
        ...
        f.defaultOptions = {
          ...
          title: { align: "middle", style: { color: x.neutralColor60 } },
          type: "linear",
  ...
  P(
    ...
    [k["Core/Axis/Axis.js"], k["Core/Utilities.js"]],
    function (f, d) {
      var k = d.addEvent,
        x = d.getMagnitude,
        ...
        D = (function () {
          ...
          d.prototype.normalizeTimeTickInterval = function (d, f) {
            ...
            for (
              ...
              (k = G[f[0]]),
              (g = f[1]),
              l[t + 1] && d <= (k * g[g.length - 1] + G[l[t + 1][0]]) / 2);
              t++
            );
            k === G.year && d < 5 * k && (g = [1, 2, 5]);
            d = B(d / k, g, "year" === f[0] ? Math.max(x(d / k), 1) : 1);
            return { unitRange: k, count: d, unitName: f[0] };
          };
          return d;
        })();
      d = (function () {
      ...
      var k = d.addEvent,
        ...
        D = (function () {
          ...
          d.prototype.getLogTickPositions = function (d, f, l, k) {
            ...
            if (0.5 <= d)
              (d = Math.round(d)), (q = g.getLinearTickPositions(d, f, l));
            else if (0.08 <= d) {
              c = Math.floor(f);
              var n, A;
              for (
              ...
              (f = this.lin2log(f)),
                (l = this.lin2log(l)),
                (d = k ? g.getMinorTickInterval() : c.tickInterval),
                (d = G(
                  "auto" === d ? null : d,
                  this.minorAutoInterval,
                  ((c.tickPixelInterval / (k ? 5 : 1)) * (l - f)) /
                    ((k ? y / g.tickPositions.length : y) || 1)
                )),
                (d = B(d, void 0, x(d))),
                (q = g.getLinearTickPositions(d, f, l).map(this.log2lin)),
                k || (this.minorAutoInterval = d / 5);
            k || (g.tickInterval = d);
            return q;
          };
    ...
    function (f, d, k, x) {
      ...
      x = (function () {
        ...
        c.prototype.render = function () {
          ...
          d.chart.styledMode ||
            (w
              ? ((F.stroke = N || k.neutralColor40),
                (F["stroke-width"] = y(z.width, 1)),
                z.dashStyle && (F.dashstyle = z.dashStyle))
              : b &&
                ((F.fill = N || k.highlightColor10),
                z.borderWidth &&
                  ((F.stroke = z.borderColor),
                  (F["stroke-width"] = z.borderWidth))));
          C.zIndex = R;
          x += "-" + R;
          (t = d.plotLinesAndBandsGroups[x]) ||
            (d.plotLinesAndBandsGroups[x] = t = v
              .g("plot-" + x)
              .attr(C)
              .add());
          ...
          (O || !J.d) && F && F.length
            ...
            : J &&
              (F
                ? (J.show(!0), J.animate({ d: F }))
                : J.d && (J.hide(), r && (c.label = r = r.destroy())));
          m &&
          (D(m.text) || D(m.formatter)) &&
          F &&
          F.length &&
          0 < d.width &&
          0 < d.height &&
        ...
        c.prototype.renderLabel = function (c, g, d, f) {
          ...
          n ||
            ...
            (n.zIndex = f),
            (f = this.getLabelText(c)),
            (this.label = n = m.text(f, 0, 0, c.useHTML).attr(n).add()),
            this.axis.chart.styledMode || n.css(c.style));
          m = g.xBounds || [g[0][1], g[1][1], d ? g[2][1] : g[0][1]];
          g = g.yBounds || [g[0][2], g[1][2], d ? g[2][2] : g[0][2]];
          d = G(m);
          f = G(g);
          n.align(c, !1, { x: d, y: f, width: B(m) - d, height: B(g) - f });
          n.show(!0);
        };
  ...
  P(
    k,
    "Core/Tooltip.js",
    [k["Core/Globals.js"], k["Core/Color/Palette.js"], k["Core/Utilities.js"]],
    function (f, d, k) {
      var x = f.doc,
        B = k.clamp,
        G = k.css,
      ...
      var M = (function () {
        ...
        z.prototype.bodyFormatter = function (c) {
          return c.map(function (c) {
            ...
            return (
              e[(c.point.formatPrefix || "point") + "Formatter"] ||
              c.point.tooltipFormatter
            ).call(
              c.point,
              e[(c.point.formatPrefix || "point") + "Format"] || ""
            );
          });
        };
        ...
        z.prototype.getAnchor = function (c, g) {
          ...
          this.followPointer && g
            ? ("undefined" === typeof g.chartX && (g = d.normalize(g)),
              (d = [g.chartX - f, g.chartY - b]))
            : c[0].tooltipPos
            ? (d = c[0].tooltipPos)
            : (c.forEach(function (c) {
                ...
                r &&
                  l &&
                  (a
                    ? ((m += b + e.plotHeight - r.len - r.pos),
                      (n += f + e.plotWidth - l.len - l.pos))
                    : ((m += r.pos - f), (n += l.pos - b)));
              }),
              (m /= c.length),
              (n /= c.length),
              (d = [a ? e.plotWidth - n : m, a ? e.plotHeight - m : n]),
              this.shared &&
                1 < c.length &&
                g &&
                (a ? (d[0] = g.chartX - f) : (d[1] = g.chartY - b)));
        ...
        z.prototype.getDateFormat = function (c, g, e, d) {
          ...
          for (m in A) {
            ...
            if (h[m] && b.substr(h[m]) !== "01-01 00:00:00.000".substr(h[m]))
              break;
            "week" !== m && (f = m);
          }
        ...
        z.prototype.getLabel = function () {
          var c,
            ...
            l =
              (null === (c = w.style) || void 0 === c
                ? void 0
                : c.pointerEvents) ||
              (!this.followPointer && w.stickOnContact ? "auto" : "none"),
            q;
          c = function () {
            d.inContact = !0;
          };
          ...
          if (!this.label) {
            if (this.outside) {
              ...
              G(q, {
                ...
                pointerEvents: l,
                zIndex: Math.max(
                  (null === (e = this.options.style) || void 0 === e
                    ? void 0
                    : e.zIndex) || 0,
                  ((null === t || void 0 === t ? void 0 : t.zIndex) || 0) + 3
                ),
              });
            ...
            this.split
              ...
              : ((this.label = a
                  ...
                  .attr({ padding: w.padding, r: w.borderRadius })),
                b ||
                  this.label
                    .attr({
        ...
        z.prototype.getPosition = function (g, d, e) {
          var h = this.chart,
            ...
            k = function (b) {
              var c = "x" === b;
              return [b, c ? l : r, c ? g : d].concat(
                n
                  ? [
                      c ? g * q.scaleX : d * q.scaleY,
                      c
                        ? q.left - a + (e.plotX + h.plotLeft) * q.scaleX
                        : q.top - a + (e.plotY + h.plotTop) * q.scaleY,
                      0,
                      c ? l : r,
                    ]
                  : [
                      c ? g : d,
                      c ? e.plotX + h.plotLeft : e.plotY + h.plotTop,
                      c ? h.plotLeft : h.plotTop,
                      c ? h.plotLeft + h.plotWidth : h.plotTop + h.plotHeight,
                    ]
              );
            },
            y = k("y"),
            v = k("x"),
            t =
              !this.followPointer && c(e.ttBelow, !h.inverted === !!e.negative),
        ...
        z.prototype.getXDateFormat = function (c, g, e) {
          ...
          return (
            (d
              ? this.getDateFormat(d, c.x, e.options.startOfWeek, g)
              : g.day) || g.year
          );
        };
        ...
        z.prototype.init = function (g, d) {
          ...
          this.outside = c(
            d.outside,
            !(!g.scrollablePixelsX && !g.scrollablePixelsY)
          );
        };
        ...
        z.prototype.move = function (c, g, e, d) {
          var a = this,
            ...
            h =
              ...
              !a.isHidden &&
              (1 < Math.abs(c - b.x) || 1 < Math.abs(g - b.y)),
        ...
        z.prototype.refresh = function (g, f) {
          ...
          if (h.enabled) {
            ...
            f = r[0];
            var N = r[1];
            !b || (a.series && a.series.noSharedTooltip)
              ? (b = a.getLabelConfig())
              : (e.pointer.applyInactiveState(a),
                a.forEach(function (a) {
                  a.setState("hover");
                  m.push(a.getLabelConfig());
                }),
                (b = { x: a[0].category, y: a[0].y }),
                (b.points = m),
                (a = a[0]));
            this.len = m.length;
            e = n.call(b, this);
            ...
            !1 === e
              ? this.hide()
              : (this.split
                  ? this.renderSplit(e, q(g))
                  : ((g = this.getLabel()),
                    (h.style.width && !l) ||
                      g.css({ width: this.chart.spacingBox.width + "px" }),
                    g.attr({ text: e && e.join ? e.join("") : e }),
                    g
                      .removeClass(/highcharts-color-[\d]+/g)
                      .addClass(
                        "highcharts-color-" + c(a.colorIndex, n.colorIndex)
                      ),
                    l ||
                      g.attr({
                        stroke:
        ...
        z.prototype.renderSplit = function (m, n) {
          function e(a, b, e, c, g) {
            void 0 === g && (g = !0);
            e
              ? ((b = aa ? 0 : U), (a = B(a - c / 2, x.left, x.right - c)))
              : ((b -= I),
                (a = g ? a - c - p : a + p),
                (a = B(a, g ? a : x.left, x.right)));
            return { x: a, y: b };
          }
          var h = this,
            a = h.chart,
          ...
          m = m.slice(0, n.length + 1).reduce(function (a, b, g) {
            if (!1 !== b && "" !== b) {
              ...
              var F = g.series;
              var N =
                "highcharts-color-" + c(g.colorIndex, F.colorIndex, "none");
              r ||
                ((r = { padding: C.padding, r: C.borderRadius }),
                E ||
                  ((r.fill = C.backgroundColor),
                ...
                (r = k
                  .label(
                    ...
                    0,
                    0,
                    C[J ? "headerShape" : "shape"] || "callout",
                    void 0,
                    void 0,
                    C.useHTML
                  )
                  .addClass(
                    (J ? "highcharts-tooltip-header " : "") +
              ...
              E ||
                r
                  ...
                  .attr({
                    stroke:
                      C.borderColor || g.color || F.color || d.neutralColor80,
                  });
              b = m.tt = r;
              J = b.getBBox();
          ...
          h.outside &&
            ...
            a &&
            ((b = u.getBBox()),
            a.setSize(b.width + b.x, b.height + b.y, !1),
        ...
        z.prototype.drawTracker = function () {
          if (this.followPointer || !this.options.stickOnContact)
            ...
            if (g && e) {
              ...
              d.width =
                0 > e[0]
                  ? Math.max(Math.abs(e[0]), a.width - e[0])
                  : Math.max(Math.abs(e[0]), a.width);
              d.height =
                0 > e[1]
                  ? Math.max(Math.abs(e[1]), a.height - Math.abs(e[1]))
                  : Math.max(Math.abs(e[1]), a.height);
              this.tracker
                ? this.tracker.attr(d)
        ...
        z.prototype.tooltipFooterHeaderFormatter = function (c, g) {
          ...
          C(this, "headerFormatter", g, function (e) {
            ...
            e.text = l(n, { point: c, series: d }, this.chart);
          });
          return g.text;
        };
      ...
      f = (function () {
          ...
          if (!y || !y.touch)
            if (
              ...
              c.hasCartesianSeries &&
                ...
                !z &&
                !y &&
                ((this.selectionMarker = y = c.renderer
                  .rect(m, l, d ? 1 : q, f ? 1 : r, 0)
                ...
                c.styledMode ||
                  y.attr({
                    fill:
                      ...
                      G(k.highlightColor80).setOpacity(0.25).get(),
                  }));
              y &&
                d &&
                ((b -= v),
                y.attr({ width: Math.abs(b), x: (0 < b ? 0 : b) + v }));
              y &&
                f &&
                ((b = g - t),
                y.attr({ height: Math.abs(b), y: (0 < b ? 0 : b) + t }));
        ...
        f.prototype.drop = function (e) {
          ...
          if (this.selectionMarker) {
            var f = { originalEvent: e, xAxis: [], yAxis: [] },
            ...
            if (this.hasDragged || b)
              a.axes.forEach(function (a) {
                if (
                  a.zoomEnabled &&
                  E(a.min) &&
                  (b || d[{ xAxis: "zoomX", yAxis: "zoomY" }[a.coll]]) &&
                  q(n) &&
                  q(r)
                ) {
                  var c = a.horiz,
                ...
                t &&
                  c(a, "selection", f, function (e) {
                    a.zoom(g(e, b ? { animation: !1 } : null));
                  });
            q(a.index) &&
          ...
          a &&
            q(a.index) &&
            (l(a.container, { cursor: a._cursor }),
        ...
        f.prototype.getChartCoordinatesFromPoint = function (e, c) {
          ...
          if (b && a)
            return c
              ? { chartX: b.len + b.pos - g, chartY: a.len + a.pos - e.plotY }
              : { chartX: g + b.pos, chartY: e.plotY + a.pos };
        ...
        f.prototype.getChartPosition = function () {
          ...
          2 < a &&
            2 < e &&
            ((this.chartPosition.scaleX = c.width / a),
            (this.chartPosition.scaleY = c.height / e));
            ...
            (d && !g.noSharedTooltip
              ? ((w = a.filter(function (a) {
                ...
                w.forEach(function (a) {
                  ...
                  n(b) &&
                    (a.chart.isBoosting && (b = a.getPoint(b)), m.push(b));
                }))
              : m.push(h));
          l = { hoverPoint: h };
          c(this, "afterGetHoverData", l);
          return { hoverPoint: l.hoverPoint, hoverSeries: g, hoverPoints: m };
        };
        ...
        f.prototype.onTrackerMouseOut = function (e) {
          ...
          if (
            !(
              ...
              !e ||
              c.stickyTracking ||
              this.inClass(e, "highcharts-tooltip") ||
              (this.inClass(e, "highcharts-series-" + c.index) &&
                this.inClass(e, "highcharts-tracker"))
            )
          )
            c.onMouseOut();
        };
        ...
        f.prototype.normalize = function (e, c) {
          var a = e.touches,
            b = a
              ? a.length
                ? a.item(0)
                : z(a.changedTouches, e.changedTouches)[0]
              : e;
          ...
          a /= c.scaleX;
          b /= c.scaleY;
          return g(e, { chartX: Math.round(a), chartY: Math.round(b) });
        };
        f.prototype.onContainerClick = function (e) {
          ...
          var b = d.plotLeft,
            f = d.plotTop;
          d.cancelClick ||
            (a && this.inClass(e.target, "highcharts-tracker")
              ? (c(a.series, "click", g(e, { point: a })),
                d.hoverPoint && a.firePointEvent("click", e))
              : (g(e, this.getCoordinates(e)),
                d.isInsidePlot(e.chartX - b, e.chartY - f) &&
                  c(d, "click", e)));
        };
        f.prototype.onContainerMouseDown = function (e) {
          ...
          if ("undefined" === typeof e.button || c)
            this.zoomOption(e),
              c && e.preventDefault && e.preventDefault(),
              this.dragStart(e);
        };
        ...
        f.prototype.onContainerMouseMove = function (e) {
          ...
          ("mousedown" === c.mouseIsDown || this.touchSelect(e)) &&
            this.drag(e);
          c.openMenu ||
            (!this.inClass(e.target, "highcharts-tracker") &&
              !c.isInsidePlot(e.chartX - c.plotLeft, e.chartY - c.plotTop)) ||
        ...
        f.prototype.pinch = function (e) {
          var c = this,
            ...
            r =
              1 === f &&
              ((c.inClass(e.target, "highcharts-tracker") &&
                a.runTrackerClick) ||
                c.runChartClick),
            k = {};
          1 < f && (c.initiated = !0);
          ...
          "touchstart" === e.type
            ? ([].forEach.call(d, function (a, e) {
                b[e] = { chartX: a.chartX, chartY: a.chartY };
              }),
              ...
              a.axes.forEach(function (b) {
                if (b.zoomEnabled) {
                  var e = a.bounds[b.horiz ? "h" : "v"],
                    c = b.minPixelPadding,
                    g = b.toPixels(
                      Math.min(z(b.options.min, b.dataMin), b.dataMin)
                    ),
                    d = b.toPixels(
                      Math.max(z(b.options.max, b.dataMax), b.dataMax)
                    ),
                    f = Math.max(g, d);
            ...
            ? this.runPointActions(c.normalize(e))
            : b.length &&
              (l ||
                (c.selectionMarker = l = g(
                  { destroy: H, touch: !0 },
                  a.plotBox
                )),
              c.pinchTranslate(b, d, q, l, k, m),
              (c.hasPinched = n),
              c.scaleGroups(q, k),
          ...
          a.series.forEach(function (g) {
            ...
            g.xAxis &&
              ...
              g.markerGroup &&
                ...
                g.markerGroup.clip(c ? a.clipRect : null)),
        ...
        f.prototype.setDOMEvents = function () {
          ...
          this.unbindContainerMouseEnter = t(
            c,
            "mouseenter",
            this.onContainerMouseEnter.bind(this)
          );
          this.unbindContainerMouseLeave = t(
            c,
            "mouseleave",
            this.onContainerMouseLeave.bind(this)
          );
          d.unbindDocumentMouseUp ||
            (d.unbindDocumentMouseUp = t(
              a,
              "mouseup",
          ...
          for (
            ...
            t(b, "scroll", function () {
              ...
              (b = b.parentElement);
          d.hasTouch &&
            (t(c, "touchstart", this.onContainerTouchStart.bind(this), {
              passive: !1,
            }),
            ...
            if (
              ...
              if ("touchmove" === e.type) {
                ...
                var g = c[0]
                  ? 4 <=
                    Math.sqrt(
                      Math.pow(c[0].chartX - e.chartX, 2) +
                        Math.pow(c[0].chartY - e.chartY, 2)
                    )
                  : !1;
              }
              z(g, !0) && this.pinch(e);
  ...
  P(
    k,
    "Core/MSPointer.js",
    [k["Core/Globals.js"], k["Core/Pointer.js"], k["Core/Utilities.js"]],
    function (f, d, k) {
      function x() {
        var c = [];
        c.item = function (c) {
        ...
        E(y, function (g) {
          c.push({ pageX: g.pageX, pageY: g.pageY, target: g.target });
        });
        return c;
      }
      function B(c, g, d, l) {
      ...
      return (function (d) {
        ...
        f.prototype.onContainerPointerMove = function (c) {
          B(c, "onContainerTouchMove", "touchmove", function (c) {
            y[c.pointerId] = { pageX: c.pageX, pageY: c.pageY };
      ...
      d = (function () {
        ...
        a.prototype.animateBeforeDestroy = function () {
          ...
          g.singular.forEach(function (b) {
            e = "dataLabel" === b;
            a[b] = a[b].animate(
              e ? { x: a[b].startXPos, y: a[b].startYPos, opacity: 0 } : c
            );
          });
        ...
        a.prototype.destroy = function () {
          ...
          g && g.enabled
            ? (this.animateBeforeDestroy(), r(a, h.duration))
            : a();
          d.pointCount--;
        };
        ...
        a.prototype.getNestedProperty = function (a) {
          if (a)
            return 0 === a.indexOf("custom.") ? y(a, this.options) : this[a];
        };
        ...
        a.prototype.optionsToObject = function (b) {
          ...
          if (n(b) || null === b) e[f[0]] = b;
            ...
            for (
              ...
              b.length > h &&
              ((g = typeof b[0]),
              "string" === g ? (e.name = b[0]) : "number" === g && (e.x = b[0]),
              m++);
              l < h;

            )
              (d && "undefined" === typeof b[m]) ||
                (0 < f[l].indexOf(".")
                  ? a.prototype.setNestedProperty(e, b[m], f[l])
                  : (e[f[l]] = b[m])),
                m++,
                l++;
          else
        ...
        a.prototype.tooltipFormatter = function (a) {
          ...
          return g(a, { point: this, series: this.series }, b.chart);
        };
        a.prototype.update = function (a, c, e, g) {
          function b() {
            ...
            q.data[l] =
              A(q.data[l], !0) || A(a, !0) ? d.options : m(a, q.data[l]);
          ...
          var d = this,
            ...
            q = f.options;
          c = m(c, !0);
          !1 === g ? b() : d.firePointEvent("update", { options: a }, b);
        };
              ...
              if (!p.styledMode) {
                ...
                b.options.inactiveOtherPoints &&
                  ...
                  ((this.dataLabels || []).forEach(function (a) {
                    a && a.animate({ opacity: u.opacity }, z);
                  }),
                  this.connector &&
                    this.connector.animate({ opacity: u.opacity }, z));
                this.graphic.animate(u, z);
              }
              y &&
                this.graphic.animate(
                  y,
                  m(p.options.chart.animation, n.animation, d.animation)
                );
              r && r.hide();
            } else {
              if (a && n) {
                ...
                if (y)
                  if (r) r[c ? "animate" : "attr"]({ x: y.x, y: y.y });
                  else
                    e &&
                      ((b.stateMarkerGraphic = r = p.renderer
                        .symbol(e, y.x, y.y, y.width, y.height)
                        .add(b.markerGroup)),
                      (r.currentSymbol = e));
                !p.styledMode && r && r.attr(b.pointAttribs(this, a));
              }
              r &&
                (r[a && this.isInside ? "show" : "hide"](),
                (r.element.point = this));
            }
            a = g.halo;
            g = ((r = this.graphic || r) && r.visibility) || "inherit";
            a && a.size && r && "hidden" !== g && !this.isCluster
              ? (k || (b.halo = k = p.renderer.path().add(r.parentGroup)),
                k.show()[c ? "animate" : "attr"]({ d: this.haloPath(a.size) }),
                k.attr({
                  class:
                ...
                p.styledMode ||
                  k.attr(
                    l(
                      ...
                      f.filterUserAttributes(a.attributes || {})
                    )
                  ))
              : k &&
                k.point &&
    ...
    function (f, d, k, x) {
      ...
      var e = (function () {
        ...
        e.prototype.init = function (a, b) {
          ...
          b.enabled &&
            (this.render(),
            t(this.chart, "endResize", function () {
              this.legend.positionCheckboxes();
            }),
            this.proximate
              ? (this.unchartrender = t(this.chart, "render", function () {
        ...
        e.prototype.setOptions = function (a) {
          ...
          this.chart.styledMode ||
            ...
            (this.itemHiddenStyle = A(this.itemStyle, a.itemHiddenStyle)));
        ...
        e.prototype.colorizeItem = function (a, b) {
          ...
          if (!this.chart.styledMode) {
            ...
            var m = b ? a.color || h : h,
              ...
              n = { fill: m };
            g && g.css({ fill: e, color: e });
            d && d.attr({ stroke: m });
            f &&
              (l &&
                f.isMarker &&
                ((n = a.pointAttribs()), b || (n.stroke = n.fill = h)),
              f.attr(n));
          }
        ...
        e.prototype.renderItem = function (a) {
          ...
          n ||
            ...
            b.styledMode || n.css(A(a.visible ? f : h)),
            n
            ...
            this.setItemEvents && this.setItemEvents(a, n, k));
          r &&
            !a.checkbox &&
          ...
          (!b.styledMode && f.width) ||
            n.css({
              width:
                (e.itemWidth || this.widthOption || b.spacingBox.width) -
                m +
                "px",
            });
          this.setText(a);
          ...
          a.itemWidth = a.checkboxOffset =
            e.itemWidth || a.legendItemWidth || b.width + m;
        ...
        e.prototype.layoutItem = function (a) {
          ...
          b =
            b.alignColumns && this.totalItemWidth > m
              ? this.maxItemWidth
              : a.itemWidth;
          e &&
            this.itemX - c + b > m &&
            ((this.itemX = c),
            this.lastLineHeight && (this.itemY += f + this.lastLineHeight + d),
          ...
          e
            ? (this.itemX += b)
            : ((this.itemY += f + g + d), (this.lastLineHeight = g));
          this.offsetWidth =
            this.widthOption ||
            Math.max(
              (e ? this.itemX - c - (a.checkbox ? 0 : h) : b) + c,
              this.offsetWidth
            );
        };
        e.prototype.getAllItems = function () {
          ...
          this.chart.series.forEach(function (b) {
            var c = b && b.options;
            b &&
              M(c.showInLegend, E(c.linkedTo) ? !1 : void 0, !0) &&
              (a = a.concat(
        ...
        e.prototype.proximatePositions = function () {
          ...
          this.allItems.forEach(function (e) {
            ...
            if (e.yAxis) {
              ...
              e.visible
                ? ((g = g ? g.plotY : e.yAxis.height), (g += f - 0.3 * d))
                : (g = f + e.yAxis.height);
              b.push({ target: g, size: d, item: e });
            }
          }, this);
        ...
        e.prototype.handleOverflow = function (a) {
          ...
          a > d && !1 !== l.enabled
            ? ((this.clipHeight = m = Math.max(
              ...
              n ||
                ((n = b.clipRect = e.clipRect(0, f, 9999, 0)),
                b.contentGroup.clip(n)),
              t(m),
              r ||
                ((this.nav = r = e.g().attr({ zIndex: 1 }).add(this.group)),
                (this.up = e.symbol("triangle", 0, 0, p, p).add(r)),
                ...
                this.pager.add(r),
                (this.down = e.symbol("triangle-down", 0, 0, p, p).add(r)),
        ...
        e.prototype.scroll = function (a, b) {
          ...
          0 < h &&
            ...
            (b = B(M(b, g.renderer.globalAnimation, !0))),
            r(function () {
              c(e, "afterScroll", { currentPage: h });
            }, b.duration));
        };
            ...
            if (e)
              e.on("mouseover", function () {
                ...
                .on("mouseout", function () {
                  g.chart.styledMode ||
                    b.css(A(a.visible ? g.itemStyle : g.itemHiddenStyle));
                  g.allItems.forEach(function (b) {
                    a !== b && b.setState("", !f);
                  });
                  d.removeClass(h);
      ...
      (/Trident\/7\.0/.test(H.navigator && H.navigator.userAgent) || f) &&
        x(e.prototype, "positionItem", function (e, a) {
          var b = this,
            c = function () {
  ...
  P(
    ...
    function (f, d, k, x, B, G, D, H, t, C, l, E) {
      var g = f.animate,
        y = f.animObject,
        c = f.setAnimation,
        q = k.charts,
        ...
        ca = (function () {
          ...
          f.prototype.init = function (a, b) {
            ...
            Q(this, "init", { args: arguments }, function () {
              ...
              this.series = [];
              this.time =
                a.time && Object.keys(a.time).length ? new C(a.time) : k.time;
          ...
          f.prototype.initSeries = function (a) {
            ...
            var c = m[b];
            c || F(17, !0, this, { missingModuleFor: b });
            b = new c();
          ...
          f.prototype.isInsidePlot = function (a, b, c) {
            ...
            e = {
              ...
              y: a,
              isInsidePlot:
                0 <= e && e <= this.plotWidth && 0 <= a && a <= this.plotHeight,
            };
              ...
              a.isDirty &&
                ("point" === a.options.legendType
                  ? ("function" === typeof a.updateTotals && a.updateTotals(),
                    (h = !0))
                  : f && (f.labelFormatter || f.labelFormat) && (h = !0));
          ...
          f.prototype.temporaryDisplay = function (a) {
            ...
            if (a)
              for (; c && c.style; )
                c.hcOrigStyle && (b(c, c.hcOrigStyle), delete c.hcOrigStyle),
                  c.hcOrigDetached &&
          ...
          f.prototype.getContainer = function () {
            ...
            this.container = f = a("div", { id: h }, m, f);
            this._cursor = f.style.cursor;
            this.renderer = new (k[d.renderer] || k.Renderer)(
              f,
              l,
              r,
              null,
              d.forExport,
              g.exporting && g.exporting.allowHTML,
              this.styledMode
            );
            c(void 0, this);
          ...
          f.prototype.getMargins = function (a) {
            ...
            e[0] &&
              !w(c[0]) &&
              (this.plotTop = Math.max(this.plotTop, e[0] + b[0]));
            e[2] &&
              !w(c[2]) &&
              (this.marginBottom = Math.max(this.marginBottom, e[2] + b[2]));
            this.legend &&
              this.legend.display &&
          ...
          f.prototype.reflow = function (a) {
            ...
            if (!g && !b.isPrinting && d && c && (e === A || e === n)) {
              if (d !== b.containerWidth || c !== b.containerHeight)
                l.clearTimeout(b.reflowTimeout),
                  (b.reflowTimeout = da(
                    function () {
          ...
          f.prototype.setReflow = function (a) {
            ...
            !1 === a || this.unbindReflow
              ...
              : ((this.unbindReflow = r(A, "resize", function (a) {
          ...
          f.prototype.setChartSize = function (a) {
            ...
            this.plotWidth = l = Math.max(
              0,
              Math.round(e - m - this.marginRight)
            );
            this.plotHeight = n = Math.max(
              0,
              Math.round(g - u - this.marginBottom)
            );
            ...
            this.plotBox = c.plotBox = { x: m, y: u, width: l, height: n };
          ...
          f.prototype.drawChartBox = function () {
            ...
            if (h) var z = (p = g.strokeWidth());
              ...
              u = { fill: u || "none" };
              if (z || g["stroke-width"])
                (u.stroke = a.borderColor), (u["stroke-width"] = z);
            ...
            d[v](w);
            h ||
              (d.attr({ fill: l || "none" }).shadow(a.plotShadow),
              n &&
                (m
                  ? (n !== m.attr("href") && m.attr("href", n), m.animate(w))
                  : (this.plotBGImage = b.image(n, q, r, k, I).add())));
            y
              ? y.animate({ width: t.width, height: t.height })
            ...
            f[v](
              f.crisp({ x: q, y: r, width: k, height: I }, -f.strokeWidth())
            );
            this.isDirtyBox = !1;
          ...
          f.prototype.firstRender = function () {
            ...
            if (!a.isReadyToRender || a.isReadyToRender()) {
              ...
              H &&
                (a.pointer =
                  k.hasTouch || (!A.PointerEvent && !A.MSPointerEvent)
                    ? new H(a, b)
                    : new B(a, b));
              a.render();
          ...
          f.prototype.addSeries = function (a, b, c) {
            ...
            a &&
              ((b = I(b, !0)),
              Q(g, "addSeries", { options: a }, function () {
                e = g.initSeries(a);
                g.isDirtyLegend = !0;
                g.linkSeries();
                e.enabledDataSorting && e.setData(a.data, !1);
                Q(g, "afterAddSeries", { series: e });
                b && g.redraw(c);
              }));
            return e;
          };
          ...
          f.prototype.createAxis = function (a, b) {
            var c = this.options,
              ...
              g = b.redraw,
              f = b.animation;
            b = ba(b.axis, { index: this[a].length, isX: "xAxis" === a });
          ...
          f.prototype.showLoading = function (c) {
            ...
            e.styledMode ||
              (b(f, N(m.style, { zIndex: 10 })),
              b(h, m.labelStyle),
              e.loadingShown ||
                (b(f, { opacity: 0, display: "" }),
                g(
                  f,
                  { opacity: m.style.opacity || 0.5 },
          ...
          f.prototype.update = function (a, b, c, e) {
            ...
            if ((f = a.chart)) {
              ...
              aa(f, function (a, b) {
                ...
                -1 !== g.propsRequireReflow.indexOf(b) &&
            ...
            a.time &&
              (this.time === z && (this.time = new C(a.time)),
              ba(!0, g.options.time, a.time));
            aa(a, function (b, c) {
            ...
            u || (p(q) && q !== g.chartWidth) || (p(f) && f !== g.chartHeight)
              ? g.setSize(q, f, e)
              : I(b, !0) && g.redraw(e);
            Q(g, "afterUpdate", { options: a, redraw: b, animation: e });
          };
          ...
          f.prototype.showResetZoom = function () {
            ...
            Q(this, "beforeShowResetZoom", null, function () {
              b.resetZoomButton = b.renderer
                .button(c.resetZoom, null, null, a, g, d && d.hover)
          ...
          f.prototype.zoom = function (a) {
            ...
            !a || a.resetSelection
              ...
              : a.xAxis.concat(a.yAxis).forEach(function (a) {
                  ...
                  e[u ? "zoomX" : "zoomY"] &&
                    l &&
                    ((c = f.zoom(a.min, a.max)), f.displayBtn && (g = !0));
                });
            var f = b.resetZoomButton;
            g && !f
              ? b.showResetZoom()
              : !g && K(f) && (b.resetZoomButton = f.destroy());
            c &&
              b.redraw(
                I(
          ...
          f.prototype.pan = function (a, c) {
            ...
            Q(this, "pan", { originalEvent: a }, function () {
              ...
              c.forEach(function (b) {
                ...
                !n ||
                  ...
                  c.series.forEach(function (a) {
                    ...
                    p(b.dataMin) &&
                      p(b.dataMax) &&
                      ((w.startMin = Math.min(
                        I(a.options.threshold, Infinity),
                        b.dataMin,
                        w.startMin
                      )),
                      (w.startMax = Math.max(
                ...
                b = Math.min(
                  I(
                    null === w || void 0 === w ? void 0 : w.startMin,
                    q.dataMin
                  ),
                  l ? q.min : c.toValue(c.toPixels(q.min) - c.minPixelPadding)
                );
                l = Math.max(
                  I(
                    null === w || void 0 === w ? void 0 : w.startMax,
                    q.dataMax
                  ),
                  l ? q.max : c.toValue(c.toPixels(q.max) + c.minPixelPadding)
                );
                c.panningState = w;
                c.isOrdinal ||
                  ((n = b - u),
                  ...
                  c.series.length &&
                    ...
                    u >= b &&
                    r <= l &&
                    (c.setExtremes(u, r, !1, !1, { trigger: "pan" }),
                    e.resetZoomButton ||
                      f ||
                      u === b ||
                      r === l ||
      ...
      return (f.LegendSymbolMixin = {
        drawRectangle: function (d, f) {
          ...
          f.legendSymbol = this.chart.renderer
            .rect(
              H ? (d.symbolWidth - k) / 2 : 0,
              d.baseline - k + 1,
              H ? k : d.symbolWidth,
              k,
              x(d.options.symbolRadius, k / 2)
            )
        ...
        drawLineMarker: function (d) {
          ...
          D &&
            !1 !== D.enabled &&
            H &&
            ((f = Math.min(x(D.radius, C), C)),
            0 === this.symbol.indexOf("url") &&
              ((D = k(D, { width: t, height: t })), (f = 0)),
            (this.legendSymbol = D = l
              .symbol(this.symbol, H / 2 - f, d - f, 2 * f, 2 * f, D)
              .addClass("highcharts-point")
              .add(E)),
            (D.isMarker = !0));
        },
      ...
      f = (function () {
        ...
        d.prototype.init = function (a, c) {
          ...
          v(f, function (a, b) {
            N(a) &&
              e.eventOptions[b] !== a &&
              (N(e.eventOptions[b]) && p(e, b, e.eventOptions[b]),
              (e.eventOptions[b] = a),
              n(e, b, a));
          });
          if (
          ...
          J(this, "bindAxes", null, function () {
            (b.axisTypes || []).forEach(function (d) {
              e[d].forEach(function (a) {
                ...
                if (
                  c[d] === g.index ||
                  ("undefined" !== typeof c[d] && c[d] === g.id) ||
                  ("undefined" === typeof c[d] && 0 === g.index)
                )
        ...
        d.prototype.autoIncrement = function () {
          ...
          e &&
            ((a = new g.Date(b)),
            "day" === e
              ? g.set("Date", a, g.get("Date", a) + c)
              : "month" === e
              ? g.set("Month", a, g.get("Month", a) + c)
              : "year" === e && g.set("FullYear", a, g.get("FullYear", a) + c),
            (c = a.getTime() - b));
          this.xIncrement = b + c;
          return b;
        };
        ...
        d.prototype.setOptions = function (a) {
          ...
          a = T(a);
          b = b.styledMode;
          var h = { plotOptions: d, userOptions: a };
          J(this, "setOptions", h);
          ...
          (!f.negativeColor && !f.negativeFillColor) ||
            ...
            g.push(d));
          g.length &&
            e(g[g.length - 1].value) &&
            g.push(b ? {} : { color: this.color, fillColor: this.fillColor });
          J(this, "afterSetOptions", { options: f });
          return f;
        };
        ...
        d.prototype.updateData = function (a, b) {
          ...
          a.forEach(function (a, b) {
            ...
            if (m.id || R(p)) {
              if (
                ((p = this.findPointIndex(m, l)),
                -1 === p || "undefined" === typeof p
                  ? f.push(a)
                  : d[p] && a !== c.data[p]
                  ? (d[p].update(a, !1, null, !1),
                    (d[p].touched = !0),
                    n && (l = p + 1))
                  : d[p] && (d[p].touched = !0),
                !u || b !== p || (g && g.enabled) || this.hasDerivedData)
              )
                h = !0;
            } else f.push(a);
          }, this);
          ...
          null === this.xIncrement &&
            this.xData &&
            this.xData.length &&
            ((this.xIncrement = A(this.xData)), this.autoIncrement());
          return !0;
        };
            ...
            if (p && m > p)
              ...
              for (e = 0; e < m; e++)
                "undefined" !== typeof b[e] &&
                  ((g = { series: d }),
                  d.pointClass.prototype.applyOptions.apply(g, [b[e]]),
                  d.updateParallelArrays(g, e));
            k && Q(k[0]) && a(14, !0, n);
            d.data = [];
        ...
        d.prototype.getProcessedData = function (b) {
          ...
          if (n && this.sorted && !l && (!m || g > m || this.forceCrop))
          ...
          for (m = c.length || 1; --m; )
            if (
              ((g = h ? b(c[m]) - b(c[m - 1]) : c[m] - c[m - 1]),
              0 < g && ("undefined" === typeof k || g < k))
            )
              var k = g;
          ...
          for (q = 0; q < m; q++) {
            ...
            if (n) {
              ...
              k.dataGroup.options &&
                ...
                b(k, k.dataGroup.options),
                delete k.dataLabels);
            } else
              (k = e[r]) ||
                "undefined" === typeof c[r] ||
                (e[r] = k = new h().init(this, c[r], d[q]));
            k && ((k.index = r), (p[q] = k));
          }
          this.options.keys = a;
          if (e && (m !== (g = e.length) || n))
            for (q = 0; q < g; q++)
              q !== l || n || (q += m),
                e[q] && (e[q].destroyElements(), (e[q].plotX = void 0));
          this.data = e;
          this.points = p;
          J(this, "afterGeneratePoints");
        };
        d.prototype.getXExtremes = function (a) {
          return { min: M(a), max: A(a) };
        };
        d.prototype.getExtremes = function (a, b) {
          ...
          for (p = 0; p < e; p++) {
            ...
            u =
              ...
              ((g[p + l] || u) >= h && (g[p - l] || u) <= m);
            if (r && u)
              if ((r = q.length)) for (; r--; ) R(q[r]) && (d[f++] = q[r]);
              else d[f++] = q;
          }
          a = { dataMin: M(d), dataMax: A(d) };
          J(this, "afterGetExtremes", { dataExtremes: a });
          return a;
        };
          ...
          for (n = 0; n < m; n++) {
            var A = h[n],
              ...
              M =
                ...
                f.stacking &&
                f.stacking.stacks[
                  (this.negStacks && E < (w ? 0 : k) ? "-" : "") + this.stackKey
                ];
            if (
              (f.positiveValuesOnly && !f.validatePositiveValue(E)) ||
              (c.positiveValuesOnly && !c.validatePositiveValue(C))
            )
              A.isNull = !0;
            A.plotX = y = r(
              z(c.translate(C, 0, 0, 0, 1, p, "flags" === this.type), -1e5, 1e5)
            );
            ...
            F(Q) &&
              ((x = Q[0]),
              (E = Q[1]),
              x === w && N.key === M[C].base && (x = L(R(k) && k, f.min)),
              f.positiveValuesOnly && 0 >= x && (x = null),
              (A.total = A.stackTotal = H.total),
              (A.percentage = H.total && (A.y / H.total) * 100),
              (A.stackY = E),
            ...
            A.plotY = void 0;
            R(E) &&
              ((E = f.translate(E, !1, !0, !1, !0)),
              "undefined" !== typeof E && (A.plotY = z(E, -1e5, 1e5)));
        ...
        d.prototype.getClipBox = function (a, b) {
          ...
          a && !1 === c.clip && f
            ...
            : ((a = this.clipBox || e.clipBox),
              b &&
                ((a.width = e.plotSizeX),
                (a.x = (e.scrollablePixelsX || 0) * (h.scrollPositionX || 0))));
        ...
        d.prototype.setClip = function (a) {
          ...
          if (!1 !== c.clip || a)
            this.group.clip(a || d ? m : b.clipRect),
        ...
        d.prototype.drawPoints = function () {
          ...
          if (!1 !== g.enabled || this._hasPointMarkers)
            for (c = 0; c < a.length; c++) {
              ...
              var p = !!m.marker;
              if (
                ((h && "undefined" === typeof n.enabled) || n.enabled) &&
                !m.isNull &&
                !1 !== m.visible
              ) {
                ...
                this.enabledDataSorting &&
                  (m.startXPos = f.reversed ? -r.width : f.width);
                var k = !1 !== m.isInside;
                e
                  ? e[k ? "show" : "hide"](k).animate(r)
                  : k &&
                    (0 < r.width || m.hasImage) &&
                    ((m.graphic = e = b.renderer
                      .symbol(q, r.x, r.y, r.width, r.height, p ? n : g)
                      .add(d)),
                    this.enabledDataSorting &&
                      b.hasRendered &&
                      (e.attr({ x: m.startXPos }), (l = "animate")));
                e && "animate" === l && e[k ? "show" : "hide"](k).animate(r);
                if (e && !b.styledMode)
                  e[l](this.pointAttribs(m, m.selected && "select"));
        ...
        d.prototype.pointAttribs = function (a, b) {
          ...
          e = L(
            b.lineWidth,
            c.lineWidth,
            e + L(b.lineWidthPlus, c.lineWidthPlus, 0)
          );
          f = b.fillColor || c.fillColor || f;
          d = b.lineColor || c.lineColor || d;
          a = L(b.opacity, c.opacity, a);
          return { stroke: d, "stroke-width": e, fill: f, opacity: a };
        };
        d.prototype.destroy = function (a) {
          ...
          (b.axisTypes || []).forEach(function (a) {
            (l = b[a]) &&
              l.series &&
              (h(l.series, b), (l.isDirty = l.forceRedraw = !0));
          });
        ...
        d.prototype.applyZones = function () {
          ...
          if (e.length && (m || l) && p && "undefined" !== typeof p.min) {
            ...
            e.forEach(function (e, u) {
              ...
              w = Math.max(g, d);
              p.isXAxis
                ? ((h = { x: q ? w : k, y: 0, width: r, height: n }),
                  F || (h.x = b.plotHeight - h.x))
                : ((h = { x: 0, y: q ? w : k, width: n, height: r }),
                  F && (h.y = b.plotWidth - h.y));
              q &&
                c.isVML &&
                (h = p.isXAxis
                  ? { x: 0, y: A ? k : w, height: h.width, width: b.chartWidth }
                  : {
        ...
        d.prototype.invertGroups = function (a) {
          ...
          var c = this,
            e = c.chart;
          c.xAxis &&
            (c.eventsToUnbind.push(n(e, "resize", b)),
            b(),
            (c.invertGroups = b));
        };
          ...
          l
            ...
            : a.graph &&
              ...
              [a.tracker, a.markerGroup].forEach(function (a) {
                ...
                b.cursor && !d.styledMode && a.css({ cursor: b.cursor });
        ...
        d.prototype.removePoint = function (a, b, c) {
          var e = this,
            ...
            m = function () {
              ...
              e.updateParallelArrays(d || { series: e }, "splice", a, 1);
              d && d.destroy();
              e.isDirty = !0;
              e.isDirtyData = !0;
              b && h.redraw();
        ...
        d.prototype.update = function (c, e) {
          ...
          var g = this,
            ...
            p = !(
              ...
              g.hasOptionChanged("dataGrouping") ||
              g.hasOptionChanged("pointStart") ||
              g.hasOptionChanged("pointInterval") ||
              g.hasOptionChanged("pointIntervalUnit") ||
              g.hasOptionChanged("keys")
            ),
            r = q[h].prototype,
            k,
            w = ["eventOptions", "navigatorSeries", "baseSeries"],
            u = g.finishedAnimating && { animation: !1 },
            y = {};
          p &&
            (w.push(
              "data",
            ...
            !1 !== c.visible && w.push("area", "graph"),
            g.parallelArrays.forEach(function (a) {
              w.push(a + "Data");
            }),
            c.data &&
              (c.dataSorting && b(g.options.dataSorting, c.dataSorting),
          ...
          if (q[n || h]) {
            if (((f = n !== g.type), g.remove(!1, !1, !1, !0), f))
              if (Object.setPrototypeOf)
                Object.setPrototypeOf(g, q[n || h].prototype);
              else {
          ...
          } else a(17, !0, d, { missingModuleFor: n || h });
          w.forEach(function (a) {
            g[a] = w[a];
          });
          g.init(d, c);
          if (p && this.points) {
            ...
            !1 === t.visible
              ...
              : g._hasPointLabels ||
                ((c = t.marker),
                (n = t.dataLabels),
                c && (!1 === c.enabled || "symbol" in c) && (y.graphic = 1),
                n && !1 === n.enabled && (y.dataLabel = 1));
            this.points.forEach(function (a) {
              a &&
                a.series &&
                (a.resolveColor(),
                Object.keys(y).length && a.destroyElements(y),
                !1 === t.showInLegend &&
                  a.legendItem &&
        ...
        d.prototype.setState = function (a, b) {
          ...
          if (
            ...
            if (g && !g.dashstyle)
              for (
                f = { "stroke-width": h }, g.animate(f, l);
                c["zone-graph-" + e];
        ...
        d.prototype.setVisible = function (a, b) {
          var c = this,
            ...
            f = c.visible;
          var h = (c.visible = a = c.options.visible = c.userOptions.visible =
  ...
  P(
    ...
    function (f, d, k, x, B, G) {
        ...
        if (!this.renderer.forExport) {
          if (f) {
            if (
              ...
              this.plotWidth += f;
              this.inverted
                ? ((this.clipBox.height += f), (this.plotBox.height += f))
                : ((this.clipBox.width += f), (this.plotBox.width += f));
              var c = { 1: { name: "right", value: f } };
            }
          } else
            g &&
              (this.scrollablePixelsY = f = Math.max(
                0,
                g - this.chartHeight
              )) &&
              ((this.scrollablePlotBox = C(this.plotBox)),
            ...
            this.axes.forEach(function (g) {
              c[g.side]
                ? (g.getPlotLinePath = function () {
                    ...
                    var l = B.Axis.prototype.getPlotLinePath.apply(
                      this,
                      arguments
                    );
                    this[d] = f;
      ...
      k.prototype.moveFixedElements = function () {
        ...
        c &&
          f.push(
            c + ":not(.highcharts-radial-axis)",
            c + "-labels:not(.highcharts-radial-axis-labels)"
          );
      ...
      k.prototype.applyFixed = function () {
        ...
        q
          ? ((this.fixedDiv = t(
            ...
            (this.fixedRenderer = g = new B.Renderer(
              this.fixedDiv,
              this.chartWidth,
              this.chartHeight,
              null === (c = this.options.chart) || void 0 === c
                ? void 0
                : c.style
            )),
        ...
        q &&
          (A.scrollPositionX &&
            (this.scrollingContainer.scrollLeft =
              this.scrollablePixelsX * A.scrollPositionX),
          A.scrollPositionY &&
            (this.scrollingContainer.scrollTop =
              this.scrollablePixelsY * A.scrollPositionY));
        g = this.axisOffset;
  ...
  P(
    ...
    [k["Core/Animation/AnimationUtilities.js"], k["Core/Utilities.js"]],
    function (f, d) {
        ...
        t = (function () {
          ...
          d.prototype.resetStacks = function () {
            ...
            d.axis.isXAxis ||
              D(f, function (g) {
                D(g, function (f, c) {
                  f.touched < d.stacksTouched
                    ? (f.destroy(), delete g[c])
    ...
    function (f, d, k, x, B, G) {
      ...
      var y = (function () {
        function c(c, g, d, f, l) {
          ...
          this.alignOptions = {
            ...
            verticalAlign:
              g.verticalAlign || (m ? "middle" : d ? "bottom" : "top"),
            y: g.y,
            x: g.x,
          };
          this.textAlign =
            g.textAlign || (m ? (d ? "right" : "left") : "center");
        }
        c.prototype.destroy = function () {
          t(this, this.axis);
        };
        c.prototype.render = function (c) {
          ...
          this.label
            ...
            : ((this.label = d.renderer.label(
              ...
              d.styledMode ||
                ((l.fill = f.backgroundColor),
                (l.stroke = f.borderColor),
                (l["stroke-width"] = f.borderWidth),
        ...
        c.prototype.setOffset = function (c, d, f, l, k) {
          var m = this.axis,
            n = m.chart;
          l = m.translate(
            m.stacking.usePercentage ? 100 : l ? l : this.total,
            0,
            0,
            0,
            1
          ...
          d &&
            ...
            (e =
              "left" === e
                ...
                ? f
                  ...
                  : -l
                : k.width / 2),
            (f = n.inverted ? k.height / 2 : f ? -l : k.height),
            ...
            n.isInsidePlot(
              d.alignAttr.x + e - this.alignOptions.x,
              d.alignAttr.y + f - this.alignOptions.y
            )
              ? d.show()
              : ((d.alignAttr.y = -9999), (c = !1)),
            c &&
            ...
            g(!c && this.options.crop, !0) &&
              ((n =
                E(d.x) &&
                E(d.y) &&
                n.isInsidePlot(d.x - l + d.width, d.y) &&
                n.isInsidePlot(d.x + l, d.y)) ||
                d.hide()));
        };
        c.prototype.getStackBox = function (c, g, d, f, l, m, k) {
          ...
          return {
            x: h
              ? g
                ? f - k.right
                : f - m + k.pos - c.plotLeft
              : d + c.xAxis[0].transB - c.plotLeft,
      ...
      d.prototype.getStacks = function () {
        ...
        c.series.forEach(function (f) {
          ...
          !f.options.stacking ||
            (!0 !== f.visible && !1 !== c.options.chart.ignoreHiddenSeries) ||
            (f.stackKey = [
              f.type,
              g(f.options.stack, ""),
              d ? l.top : l.left,
      ...
      x.prototype.setStackedPoints = function (c) {
        ...
        if (
          ...
          for (F = 0; F < z; F++) {
            ...
            w[v][x] ||
              (C[v] && C[v][x]
                ? ((w[v][x] = C[v][x]), (w[v][x].total = null))
                : (w[v][x] = new y(b, b.options.stackLabels, E, x, m)));
            v = w[v][x];
            null !== R
              ? ((v.points[B] = v.points[this.index] = [g(v.cumulative, e)]),
                H(v.cumulative) || (v.base = B),
                (v.touched = b.stacking.stacksTouched),
                0 < Q.index &&
                  !1 === this.singleStacks &&
                  (v.points[B][0] = v.points[this.index + "," + x + ",0"][0]))
              : (v.points[B] = v.points[this.index] = null);
            "percent" === d
              ? ((E = E ? c : h),
                a && w[E] && w[E][x]
                  ? ((E = w[E][x]),
                    (v.total = E.total =
                      Math.max(E.total, v.total) + Math.abs(R) || 0))
                  : (v.total = D(v.total + (Math.abs(R) || 0))))
              : "group" === d
              ? (l(R) && (R = R[0]),
                null !== R && (v.total = (v.total || 0) + 1))
              : (v.total = D(v.total + (R || 0)));
            v.cumulative =
              "group" === d
                ? (v.total || 1) - 1
                : g(v.cumulative, e) + (R || 0);
            null !== R &&
              (v.points[B].push(v.cumulative),
              (t[F] = v.cumulative),
              (v.hasValidPoints = !0));
          }
        ...
        c[k + "Stacker"] &&
          [g, "-" + g].forEach(function (g) {
            for (var m = f.length, e, h; m--; )
              if (
                ((e = f[m]),
                (l = c.getStackIndicator(l, e, c.index, g)),
                (h = (e = d[g] && d[g][e]) && e.points[l.key]))
              )
                c[k + "Stacker"](h, e, m);
          });
      };
    ...
    function (f, d, k, x) {
      ...
      x = (function (k) {
        ...
        t.prototype.drawGraph = function () {
          ...
          g ||
            t[0].push(
              l.lineColor || this.color || f.neutralColor20,
              l.dashStyle
            );
          ...
          t.forEach(function (c, f) {
            var n = c[0],
              ...
              t = q ? "animate" : "attr";
            q
              ? ((q.endX = d.preventGraphAnimation ? null : k.xMap),
                q.animate({ d: k }))
              : k.length &&
                (d[n] = q = d.chart.renderer
                  .path(k)
                  .addClass(c[1])
                  .attr({ zIndex: 1 })
                  .add(d.group));
        ...
        t.prototype.getGraphPath = function (d, f, k) {
          ...
          (c = { right: 1, center: 2 }[c] || (c && 3)) && q && (c = 4 - c);
      ...
      x = (function (d) {
        ...
        f.prototype.drawGraph = function () {
          ...
          this.zones.forEach(function (d, f) {
            l.push([
              "zone-area-" + f,
              "highcharts-area highcharts-zone-area-" + f + " " + d.className,
              d.color || g.color,
          ...
          l.forEach(function (d) {
            var l = d[0],
              ...
              m = {};
            n
              ? ((n.endX = g.preventGraphAnimation ? null : f.xMap),
                n.animate({ d: f }))
              : ((m.zIndex = 0),
                (n = g[l] = g.chart.renderer
                  .path(f)
                  .addClass(d[1])
                  .add(g.group)),
                (n.isArea = !0));
            g.chart.styledMode ||
              (m.fill = C(
                d[3],
                G(d[2]).setOpacity(C(c.fillOpacity, 0.75)).get()
              ));
            n[k](m);
            n.startX = f.xMap;
        ...
        f.prototype.getGraphPath = function (g) {
          ...
          for (k = 0; k < g.length; k++) {
            f ||
              (g[k].leftCliff = g[k].rightCliff = g[k].leftNull = g[
                k
              ].rightNull = void 0);
            var b = g[k].isNull;
            ...
            if (!b || c)
              c || a(k, k - 1, "left"),
                (b && !f && c) ||
                  (z.push(g[k]), t.push({ x: k, plotX: w, plotY: E })),
                c || a(k, k + 1, "right");
          }
          k = d.call(this, z, !0, !0);
          t.reversed = !0;
        ...
        f.defaultOptions = H(D.defaultOptions, { threshold: 0 });
        return f;
      })(D);
      f(x.prototype, { singleStacks: !1, drawLegendSymbol: d.drawRectangle });
      ...
      d = (function (d) {
        ...
        f.prototype.getPointSpline = function (d, f, l) {
          ...
          if (
            ...
            C += q;
            x > d && x > g
              ? ((x = Math.max(d, g)), (C = 2 * g - x))
              : x < d && x < g && ((x = Math.min(d, g)), (C = 2 * g - x));
            C > l && C > g
              ? ((C = Math.max(l, g)), (x = 2 * g - C))
              : C < l && C < g && ((C = Math.min(l, g)), (x = 2 * g - C));
            f.rightContX = c;
            f.rightContY = C;
          }
          f = [
            "C",
            G(t.rightContX, t.plotX, 0),
            G(t.rightContY, t.plotY, 0),
            G(n, k, 0),
            G(x, g, 0),
            k,
            g,
  ...
  P(
    ...
    [
      k["Series/Area/AreaSeries.js"],
      k["Series/Spline/SplineSeries.js"],
      k["Mixins/LegendSymbol.js"],
      k["Core/Series/SeriesRegistry.js"],
      k["Core/Utilities.js"],
    ],
      ...
      H = (function (e) {
        ...
        d.prototype.animate = function (a) {
          ...
          if (a)
            (f.scaleY = 0.001),
              ...
              d ? (f.translateX = a - c.len) : (f.translateY = a),
              b.clipBox && b.setClip(),
              b.group.attr(f);
          else {
            ...
            b.group.animate(
              ...
              q(C(b.options.animation), {
                step: function (a, e) {
                  b.group &&
                    ((f[h] = m + e.pos * (c.pos - m)), b.group.attr(f));
                },
              })
            );
          }
        ...
        d.prototype.getColumnMetrics = function () {
          ...
          b = Math.min(
            ...
            m(b.pointWidth, n * (1 - 2 * b.pointPadding))
          );
          a.columnMetrics = {
            width: b,
            offset:
              (n - b) / 2 +
              (k + ((a.columnIndex || 0) + (d ? 1 : 0)) * n - l / 2) *
                (d ? -1 : 1),
            paddedWidth: n,
            columnCount: h,
          };
            ...
            r(this.yAxis.stacking && this.yAxis.stacking.stacks, function (a) {
              if ("number" === typeof c.x && (a = a[c.x.toString()])) {
                var b = a.points[d.index],
                  e = a.total;
                g
                  ? (b && (f = h), a.hasValidPoints && h++)
                  : A(b) && ((f = b[1]), (h = e || 0));
              }
            });
            a =
              (c.plotX || 0) +
              ((h - 1) * e.paddedWidth + b) / 2 -
              b -
              f * e.paddedWidth;
          }
          return a;
        ...
        d.prototype.translate = function () {
          ...
          a.points.forEach(function (d) {
            ...
            if (n && Math.abs(B) < n) {
              B = n;
              var H =
                (!h.reversed && !d.negative) || (h.reversed && d.negative);
              M(l) &&
                M(z) &&
                d.y === l &&
                z <= l &&
            ...
            c(d.options.pointWidth) &&
              ((F = C = Math.ceil(d.options.pointWidth)),
              (E -= Math.round((F - r) / 2)));
            ...
            d.tooltipPos = b.inverted
              ? [
                  g(
                    h.len + h.pos - b.plotLeft - v,
                    h.pos - b.plotLeft,
                    h.len + h.pos - b.plotLeft
                  ),
                  f.len + f.pos - b.plotTop - (x || 0) - p - C / 2,
                  B,
                ]
              : [
                  f.left - b.plotLeft + E + C / 2,
                  g(
                    v + h.pos - b.plotTop,
                    h.pos - b.plotTop,
                    h.len + h.pos - b.plotTop
                  ),
                  B,
                ];
        ...
        d.prototype.pointAttribs = function (a, b) {
          ...
          b &&
            ...
            (f =
              a.color ||
              ("undefined" !== typeof b && l(f).brighten(a.brightness).get()) ||
              f),
            (h = a[d] || h),
            (k = a[g] || k),
            (e = a.dashStyle || e),
            (n = m(a.opacity, n)));
          d = { fill: f, stroke: h, "stroke-width": k, opacity: n };
          e && (d.dashstyle = e);
          return d;
        };
        d.prototype.drawPoints = function () {
            ...
            if (M(f.plotY) && null !== f.y) {
              ...
              a.enabledDataSorting &&
                (f.startXPos = a.xAxis.reversed
                  ...
                  : a.xAxis.width);
              h ||
                ((f.graphic = h = e[f.shapeType](g).add(f.group || a.group)) &&
                  a.enabledDataSorting &&
                  b.hasRendered &&
                  b.pointCount < d &&
                  (h.attr({ x: f.startXPos }), (m = !0), (l = "animate")));
              if (h && m) h[l](z(g));
              if (c.borderRadius) h[l]({ r: c.borderRadius });
              b.styledMode ||
                h[l](a.pointAttribs(f, f.selected && "select")).shadow(
                  !1 !== f.allowShadow && c.shadow,
                  null,
          ...
          a._hasTracking ||
            (a.trackerGroups.forEach(function (d) {
              if (a[d]) {
                ...
                !b.styledMode &&
                  a.options.cursor &&
                  a[d].css(y).css({ cursor: a.options.cursor });
              }
            }),
            (a._hasTracking = !0));
        ...
        d.defaultOptions = z(G.defaultOptions, {
          ...
          states: {
            ...
            select: { color: B.neutralColor20, borderColor: B.neutralColor100 },
          },
  ...
  P(
    ...
    [
      k["Series/Column/ColumnSeries.js"],
      k["Core/Series/SeriesRegistry.js"],
      k["Core/Utilities.js"],
    ],
    function (f, d, k) {
    ...
    function (f, d, k, x) {
      ...
      x = (function (f) {
        ...
        k.prototype.applyJitter = function () {
          ...
          f &&
            this.points.forEach(function (l, c) {
  ...
  P(
    ...
    [k["Core/Globals.js"], k["Core/Series/Series.js"], k["Core/Utilities.js"]],
    function (f, d, k) {
      var x = k.isNumber,
        B = k.pick,
        G = k.relativeLength,
      ...
      return (f.CenteredSeriesMixin = {
        getCenter: function () {
          ...
          f = [
            B(g[0], "50%"),
            B(g[1], "50%"),
            B(c && 0 > c ? void 0 : f.size, "100%"),
            B(q && 0 > q ? void 0 : f.innerSize || 0, "0%"),
          ];
          !k.angular || this instanceof d || (f[3] = 0);
          for (g = 0; 4 > g; ++g)
            (c = f[g]),
              (k = 2 > g || (2 === g && /%$/.test(c))),
              (f[g] = G(c, [l, E, y, f[2]][g]) + (k ? x : 0));
          f[3] > f[2] && (f[3] = f[2]);
          return f;
        },
      ...
      k = (function (f) {
        ...
        l.prototype.setVisible = function (d, f) {
          ...
          d !== c.visible &&
            ...
            c.legendItem && l.legend.colorizeItem(c, d),
  ...
  P(
    ...
    [
      ...
      k["Mixins/LegendSymbol.js"],
      k["Core/Color/Palette.js"],
      k["Series/Pie/PiePoint.js"],
      k["Core/Series/Series.js"],
      k["Core/Series/SeriesRegistry.js"],
      k["Core/Renderer/SVG/SVGRenderer.js"],
      k["Core/Utilities.js"],
    ],
    function (f, d, k, x, B, G, D, H, t, C) {
      var l =
          (this && this.__extends) ||
          (function () {
            var c = function (d, f) {
      ...
      C = (function (d) {
        ...
        f.prototype.drawPoints = function () {
          ...
          this.points.forEach(function (d) {
            ...
            d.graphic ||
              ((d.graphic = c[d.shapeType](d.shapeArgs).add(d.series.group)),
        ...
        f.prototype.getX = function (c, d, e) {
          ...
          return (
            f[0] +
            (d ? -1 : 1) * Math.cos(c) * (a + e.labelDistance) +
            (0 < e.labelDistance
        ...
        f.prototype.redrawPoints = function () {
          ...
          !l ||
            c.shadowGroup ||
            d.styledMode ||
            (c.shadowGroup = e.g("shadow").attr({ zIndex: -1 }).add(c.group));
          c.points.forEach(function (h) {
            ...
            if (!h.isNull && a) {
              ...
              if (!d.styledMode) {
                ...
                l &&
                  !k &&
                  (k = h.shadowGroup = e.g("shadow").add(c.shadowGroup));
                k && k.attr(f);
                b = c.pointAttribs(h, h.selected && "select");
              }
              h.delayedRendering
                ? (a.setRadialReference(c.center).attr(g).attr(f),
                  d.styledMode ||
                    a.attr(b).attr({ "stroke-linejoin": "round" }).shadow(l, k),
                  (h.delayedRendering = !1))
                : (a.setRadialReference(c.center),
                  d.styledMode || q(!0, m, b),
                  q(!0, m, g, f),
                  a.animate(m));
        ...
        f.prototype.translate = function (d) {
          ...
          for (q = 0; q < t; q++) {
            ...
            z.labelDistance = n(
              z.options.dataLabels && z.options.dataLabels.distance,
              k
            );
            ...
            z.tooltipPos = [d[0] + 0.7 * v, d[1] + 0.7 * C];
            ...
            z.labelPosition = {
              ...
              connectorPosition: {
                ...
                touchingSliceAt: { x: d[0] + v, y: d[1] + C },
              },
            };
          }
        ...
        f.prototype.updateTotals = function () {
          ...
          for (c = 0; c < f; c++)
            (b = e[c]),
              (b.percentage = 0 < d && (b.visible || !a) ? (b.y / d) * 100 : 0),
              (b.total = d);
        };
    ...
    function (f, d, k, x, B, G) {
      ...
      d.distribute = function (c, f, e) {
        ...
        for (
          ...
          for (a = c.length; a--; )
            (b = c[a]),
              (k =
                (Math.min.apply(0, b.targets) + Math.max.apply(0, b.targets)) /
                2),
              (b.pos = t(k - b.size * b.align, 0, f - b.size));
          a = c.length;
          for (b = !1; a--; )
            0 < a &&
              ...
              (c[a - 1].align = 0.5),
              c[a - 1].pos + c[a - 1].size > f &&
                (c[a - 1].pos = f - c[a - 1].size),
              c.splice(a, 1),
              (b = !0));
        }
        m.push.apply(m, l);
        ...
        c.some(function (b) {
          ...
          if (
            b.targets.some(function () {
              ...
              if (
                "undefined" !== typeof e &&
                Math.abs(m[a].pos - m[a].target) > e
              )
                return (
                  m.slice(0, a + 1).forEach(function (a) {
                    delete a.pos;
                  }),
                  (m.reducedLen = (m.reducedLen || f) - 0.1 * f),
                  m.reducedLen > 0.1 * f && d.distribute(m, f, e),
                  !0
                );
              c += m[a].size;
              a++;
      ...
      x.prototype.drawDataLabels = function () {
        ...
        var e = this,
          ...
          z = e.hasRendered || 0,
          x = b.animation;
        x = b.defer ? D(h, x, e) : { defer: 0, duration: 0 };
        var A = h.renderer;
        b = f(
          f(
            ...
            h.options.plotOptions &&
              h.options.plotOptions[e.type] &&
              h.options.plotOptions[e.type].dataLabels
          ),
          b
        );
        ...
        if (y(b) || b.enabled || e._hasPointLabels) {
          ...
          !z &&
            (z = e.dataLabelsGroup) &&
            (e.visible && B.show(!0),
            z[a.animation ? "animate" : "attr"]({ opacity: 1 }, x));
          l.forEach(function (c) {
            ...
            t.forEach(function (b, f) {
              ...
              if (m) {
                ...
                u = C(v)
                  ? g(v, u, h)
                  : (b[c.formatPrefix + "Formatter"] || b.formatter).call(u, b);
                v = b.style;
                var z = b.rotation;
                h.styledMode ||
                  ((v.color = n(b.color, v.color, e.color, k.neutralColor100)),
                  "contrast" === v.color
                    ? ((c.contrastColor = A.getContrast(c.color || e.color)),
                      (v.color =
                        (!C(t) && b.inside) || 0 > t || a.stacking
                          ? c.contrastColor
                          : k.neutralColor100))
                ...
                ? m &&
                  ...
                  (l
                    ...
                    : ((c.dataLabels = c.dataLabels || []),
                      (l = c.dataLabels[f] = z
                        ? A.text(u, 0, -9999, b.useHTML).addClass(
                  ...
                  (l.options = b),
                  l.attr(x),
                  h.styledMode || l.css(v).shadow(b.shadow),
                  l.added || l.add(B),
                  b.textPath &&
                    !b.useHTML &&
                    (l.setTextPath(
        ...
        var b = this,
          ...
          p =
            ...
            (c.series.forceDL ||
              ...
              (e.inside &&
                f &&
                g.isInsidePlot(k, h ? f.x + 1 : f.y + f.height - 1, h)));
        var y = function (e) {
          m && b.xAxis && !x && b.setDataLabelStartPos(c, d, a, v, e);
        };
        if (p) {
          var C = g.renderer.fontMetrics(
            g.styledMode ? void 0 : e.style.fontSize,
            d
          ).b;
          f = l(
            {
          ...
          l(e, { width: r.width, height: r.height });
          t
            ? ((x = !1),
              (k = g.renderer.rotCorr(C, t)),
              (k = {
              ...
              y(k),
              d[a ? "attr" : "animate"](k).attr({ align: z }),
              (y = (t + 720) % 360),
              (y = 180 < y && 360 > y),
              "left" === z
                ? (k.y -= y ? r.height : 0)
                : "center" === z
                ? ((k.x -= r.width / 2), (k.y -= r.height / 2))
                : "right" === z &&
                  ((k.x -= r.width), (k.y -= y ? 0 : r.height)),
              (d.placed = !0),
              (d.alignAttr = k))
            : (y(f), d.align(e, null, f), (k = d.alignAttr));
          x && 0 <= f.height
            ? this.justifyDataLabel(d, e, k, r, f, a)
            : n(e.crop, !0) &&
              (p =
                g.isInsidePlot(k.x, k.y) &&
                g.isInsidePlot(k.x + r.width, k.y + r.height));
          if (e.shape && !t)
            d[a ? "attr" : "animate"]({
      ...
      x.prototype.setDataLabelStartPos = function (c, d, e, f, a) {
        ...
        b.hasRendered &&
          (e && d.attr({ x: d.startXPos, y: d.startYPos }), (d.placed = !0));
      };
      ...
      B.pie &&
        ...
        (B.pie.prototype.drawDataLabels = function () {
          ...
          f.visible &&
            ...
            x.prototype.drawDataLabels.apply(f),
                ...
                (b.visible
                  ? (P[b.half].push(b),
                    ...
                    !C(a.style.width) &&
                      ...
                      b.dataLabel.getBBox().width > y &&
                      (b.dataLabel.css({ width: Math.round(0.7 * y) + "px" }),
              ...
              if (k) {
                ...
                if (0 < f.maxLabelDistance) {
                  ...
                  c.forEach(function (a) {
                    0 < a.labelDistance &&
                      a.dataLabel &&
                      ((a.top = Math.max(0, v - E - a.labelDistance)),
                      (a.bottom = Math.min(
                        v + E + a.labelDistance,
                        h.plotHeight
                      )),
                ...
                for (X = 0; X < k; X++) {
                  ...
                  D._attr = { visibility: I, align: G.alignment };
                  Y = e.options.dataLabels || {};
                  D._pos = {
                    x:
                      u +
                      n(Y.x, a.x) +
                      ({ left: b, right: -b }[G.alignment] || 0),
                    y: S + n(Y.y, a.y) - 10,
                  };
                  G.final.x = u;
                  G.final.y = S;
                  n(a.crop, !0) &&
                    ...
                    u - p < b && 1 === g
                      ...
                      : u + p > q - b &&
                        0 === g &&
                        ((r = Math.round(u + p - q + b)),
                        (U[1] = Math.max(r, U[1]))),
                    0 > S - M / 2
                      ? (U[0] = Math.max(Math.round(-S + M / 2), U[0]))
                      : S + M / 2 > t &&
                        (U[2] = Math.max(Math.round(S + M / 2 - t), U[2])),
                    (D.sideOverflow = r));
                }
              }
            }),
                    ...
                    (b.connector = A = h.renderer
                      ...
                      h.styledMode ||
                        A.attr({
                          "stroke-width": l,
                          stroke:
                            Y.connectorColor || b.color || k.neutralColor60,
                        });
                  A[d ? "attr" : "animate"]({ d: b.getConnectorPath() });
                  A.attr("visibility", I);
        ...
        (B.pie.prototype.alignDataLabel = f),
        (B.pie.prototype.verifyDataLabelOverflow = function (c) {
          var d = this.center,
            e = this.options,
            f = e.center,
            a = e.minSize || 80,
          ...
          if (!b) {
            if (null !== f[0]) var g = Math.max(d[2] - Math.max(c[1], c[3]), a);
              ...
              (g = Math.max(d[2] - c[1] - c[3], a)),
                (d[0] += (c[3] - c[1]) / 2);
            null !== f[1]
              ? (g = t(g, a, d[2] - Math.max(c[0], c[2])))
              : ((g = t(g, a, d[2] - c[0] - c[2])),
                (d[1] += (c[0] - c[2]) / 2));
            g < d[2]
              ? ((d[2] = g),
                (d[3] = Math.min(A(e.innerSize || 0, g), g)),
                this.translate(d),
      ...
      B.column &&
        (B.column.prototype.alignDataLabel = function (d, f, e, g, a) {
          ...
          k &&
            ...
            (k = g.y + g.height - h.yAxis.len),
            0 < k && k < g.height && (g.height -= k),
            b &&
              (g = {
            ...
            m ||
              (b
                ? ((g.x += l ? 0 : g.width), (g.width = 0))
                : ((g.y += l ? g.height : 0), (g.height = 0))));
          e.align = n(e.align, !b || m ? "center" : l ? "right" : "left");
          e.verticalAlign = n(
            e.verticalAlign,
            b || m ? "middle" : l ? "top" : "bottom"
          );
          x.prototype.alignDataLabel.call(this, d, f, e, g, a);
          e.inside && d.contrastColor && f.css({ color: d.contrastColor });
        });
    }
  );
  P(
    ...
    [k["Core/Chart/Chart.js"], k["Core/Utilities.js"]],
    function (f, d) {
      var k = d.addEvent,
        x = d.fireEvent,
        B = d.isArray,
      ...
      k(f, "render", function () {
        ...
        (this.yAxis || []).forEach(function (f) {
          f.stacking &&
            ...
            D(f.stacking.stacks, function (f) {
              D(f, function (f) {
                d.push(f.label);
              });
            });
      ...
      f.prototype.hideOverlappingLabels = function (d) {
        ...
        var n = function (c) {
          ...
          if (c && (!c.alignAttr || c.placed)) {
            var a = c.alignAttr || { x: c.attr("x"), y: c.attr("y") };
            var b = c.parentGroup;
            c.width ||
              ((d = c.getBBox()),
              (c.width = d.width),
            ...
            var k = c.width - 2 * f;
            (g = { left: "0", center: "0.5", right: "1" }[c.alignValue])
              ? (e = +g * k)
              : G(c.x) &&
        ...
        for (y = 0; y < k; y++) {
          ...
          for (g = y + 1; g < k; ++g) {
            ...
            !A ||
              ...
              B.y >= A.y + A.height ||
              B.y + B.height <= A.y ||
              ((n.labelrank < c.labelrank ? n : c).newOpacity = 0);
          }
        }
  ...
  P(
    ...
    function (f, d) {
      ...
      f.prototype.setResponsive = function (d, f) {
        ...
        l = l.toString() || void 0;
        l !== (c && c.ruleIds) &&
          (c && this.update(c.undoOptions, d, !0),
          l
            ? ((c = this.currentOptions(f)),
      ...
      f.prototype.matchResponsiveRule = function (d, f) {
        ...
        (
          ...
          function () {
            return (
              this.chartWidth <= H(g.maxWidth, Number.MAX_VALUE) &&
              this.chartHeight <= H(g.maxHeight, Number.MAX_VALUE) &&
              this.chartWidth >= H(g.minWidth, 0) &&
              this.chartHeight >= H(g.minHeight, 0)
            );
          }
        ...
        function f(c, d, k, l) {
          ...
          D(c, function (c, m) {
            if (!l && -1 < g.collectionsWithUpdate.indexOf(m) && d[m])
              for (
                c = t(c), k[m] = [], n = 0;
                n < Math.max(c.length, d[m].length);
                n++
              )
                d[m][n] &&
                  (void 0 === c[n]
                    ? (k[m][n] = d[m][n])
                    : ((k[m][n] = {}), f(c[n], d[m][n], k[m][n], l + 1)));
            else
              B(c)
                ? ((k[m] = x(c) ? [] : {}), f(c, d[m] || {}, k[m], l + 1))
                : (k[m] = "undefined" === typeof d[m] ? null : d[m]);
          });
        }
        var g = this,
          k = {};
