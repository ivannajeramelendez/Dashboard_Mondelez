  ...
  q(
    ...
    function(e, l, g, k, q, f) {
      ...
      g.post = function(a, b, c) {
        var d = x(
          "form",
          p({ method: "post", action: a, enctype: "multipart/form-data" }, c),
          { display: "none" },
          A.body
        );
        E(b, function(a, b) {
      ...
      z(e.prototype, {
        ...
        getSVGForExport: function(a, b) {
          ...
          return this.getSVG(
            p({ chart: { borderRadius: 0 } }, c.chartOptions, b, {
              exporting: {
        ...
        addButton: function(a) {
          ...
          if (!1 !== d.enabled) {
            ...
            d.text && d.symbol
              ...
              : d.text ||
                z(h, { width: d.width, height: d.height, padding: 0 });
            b.styledMode ||
            ...
            n.add(b.exportingGroup).align(
              z(d, { width: n.width, x: t(d.x, b.buttonOffset) }),
              !0,
              "spacingBox"
            );
            b.buttonOffset +=
